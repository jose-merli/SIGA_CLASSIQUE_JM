 ...
 * @author Jens Kapitza
 * @version $Revision: 1.1 $ $Date: 2010-01-22 11:42:09 $ $Author: jorge $
 */
public class AjaxUpdateMultipleSelectFromSelectTag extends BaseAjaxTag {
	...
	private static final long serialVersionUID = -7774526024294932262L;
	 private String emptyOptionValue;
	    ...
	    public int doEndTag() throws JspException {
	        ...
	        script.append(" new AjaxJspTag.UpdateMultipleSelectFromSelect(\n").append("{\n").append(options.toString())
	                .append("});\n");
	        out(script);
