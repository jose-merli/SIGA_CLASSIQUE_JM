...
public class CenPersonaAdm extends MasterBeanAdmVisible {
	...
	public CenPersonaBean existePersona (String nifcif, String nombre, String apellido1, String apellido2, String continuar) throws ClsExceptions, SIGAException{
		...
		try {
			...
			Hashtable codigos = new Hashtable();
			codigos.put(new Integer(1),UtilidadesString.LTrim(nifcif.toUpperCase(),"0"));
			Vector personas = selectBind("WHERE ltrim(UPPER(" +CenPersonaBean.C_NIFCIF+"),'0') = :1 AND ROWNUM = 1",codigos);			
	...
	public CenPersonaBean getPersona2 (String nifcif) throws ClsExceptions{
