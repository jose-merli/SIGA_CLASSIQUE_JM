	...
	public Vector getAbonosBancoSjcs (String institucion, String codigoBanco, Integer idsufijo) throws ClsExceptions,SIGAException {
		...
		try {
			...
			String sql =
					...
					"       NVL(" + FcsPagosJGBean.T_NOMBRETABLA + "." + FcsPagosJGBean.C_IDPROPSEPA + " , '') AS IDPROPSEPA," +
					"       NVL(" + FcsPagosJGBean.T_NOMBRETABLA + "." + FcsPagosJGBean.C_IDPROPOTROS + ", '') AS IDPROPOTROS," +
