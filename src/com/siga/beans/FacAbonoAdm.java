...
//			}
	      ...
	      // del merge (revisar)
public Vector getRetencionesIRPF (String idInstitucion, String idPersona,String anyoRetencionIRPF) throws ClsExceptions,SIGAException {
			...
			try {
	            ...
	            sql.append(" SUM(TOTALIMPORTESJCS) TOTALIMPORTESJCS, SUM(TOTALIMPORTEIRPF) TOTALIMPORTEIRPF ");
	            ...
	            sql.append(" (((SUM(TOTALIMPORTESJCS) + SUM(IMPORTETOTALMOVIMIENTOS)) * ");
	            sql.append(" MAX(PORCERTAJEIRPF)) / 100) AS TOTALIMPORTEIRPF ");
	            sql.append(" FROM ((SELECT IDPERSONA AS IDPERSONASJCS, ");
	            sql.append(" SUM(IMPORTEPAGADO) AS TOTALIMPORTESJCS, ");
	            sql.append(" 0 AS IMPORTETOTALRETENCIONES, ");
	            sql.append(" 0 AS IMPORTETOTALMOVIMIENTOS, ");
	            sql.append(" MAX(PORCENTAJEIRPF) AS PORCERTAJEIRPF, ");
	            sql.append(" IDPAGOSJG AS IDPAGOS ");
	            sql.append(" FROM FCS_PAGO_ACTUACIONDESIGNA ");
	            sql.append(" WHERE IDINSTITUCION = :");
	            codigo++;
	            sql.append(codigo);
	            htCodigos.put(new Integer(codigo), idInstitucion);
	            sql.append(" GROUP BY IDPERSONA, IDPAGOSJG) UNION ALL ");
	            ...
	            sql.append(" MAX(PORCENTAJEIRPF) AS PORCERTAJEIRPF, ");
	            sql.append(" IDPAGOSJG AS IDPAGOS ");
	            sql.append(" FROM FCS_PAGO_APUNTE ");
	            sql.append(" WHERE IDINSTITUCION = :");
	            codigo++;
	            sql.append(codigo);
	            htCodigos.put(new Integer(codigo), idInstitucion);
	            ...
	            sql.append(" 0 AS PORCERTAJEIRPF, ");
	            sql.append(" IDPAGOSJG AS IDPAGOS ");
