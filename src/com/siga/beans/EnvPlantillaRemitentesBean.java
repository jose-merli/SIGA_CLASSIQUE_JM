...
public class EnvPlantillaRemitentesBean extends MasterBean {
    
	/**
	 * 
	 */
	private static final long serialVersionUID = -8391986709326481228L;
	//Variables
    private Integer idTipoEnvios, idPlantillaEnvios;
	...
	static public final String T_NOMBRETABLA = "ENV_PLANTILLAREMITENTES";	


	
	
	/**
	 * @return Returns the idPlantillaEnvios.
	 */
	public Integer getIdPlantillaEnvios() {
		return idPlantillaEnvios;
	}
	/**
	 * @param idPlantillaEnvios The idPlantillaEnvios to set.
	 */
