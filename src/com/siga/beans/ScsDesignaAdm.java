	...
	public Vector getDesignaCartaAcreditacionOficio(String idInstitucion, String idTurno, String anio, String numero) throws ClsExceptions {
		try {
			...
			String sql = "select TO_CHAR(ACTUACION.FECHA,'dd/mm/yyyy') AS ACTUACION_FECHA_ACTUACION, "+
			        ...
			        " TO_CHAR(ACTUACION.FECHAJUSTIFICACION,'dd/mm/yyyy') AS ACTUACION_FECHAJUSTIFICACION, "+
			        ...
			        " ACTUACION.ANIO AS DESIGNA_ANIO_DESIGNA, "+
			        ...
			        " TO_CHAR(DESIGNA.FECHAENTRADA,'dd/mm/yyyy') AS DESIGNA_FECHA, "+
			        " TO_CHAR(DESIGNA.FECHAJUICIO,'dd/mm/yyyy') AS DESIGNA_FECHAJUICIO, "+
			        " TO_CHAR(DESIGNA.FECHAJUICIO, 'HH24:MI') AS DESIGNA_HORAJUICIO, "+
			        " TO_CHAR(DESIGNA.FECHAOFICIOJUZGADO,'dd/mm/yyyy') AS DESIGNA_FECHAOFICIOJUZGADO, "+
			        " TO_CHAR(DESIGNA.FECHARECEPCIONCOLEGIO,'dd/mm/yyyy') AS DESIGNA_FECHARECEPCIONCOLEGIO, "+
			        ...
			        " DESIGNA.ANIOPROCEDIMIENTO AS DESIGNA_ANIOPROCEDIMIENTO, "+
			        ...
			        " JUZGADO_DESIGNA.IDPROVINCIA AS DESIGNA_JUZGADO_IDPROVINCIA, "+
			        ...
			        " TURNO.ABREVIATURA AS DESIGNA_TURNO_ABREV, "+
