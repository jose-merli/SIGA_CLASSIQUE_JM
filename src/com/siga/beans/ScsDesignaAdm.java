...
//					if((String)registro.get("PARRAFO_LETRADO_PROCURADOR")!=null && !((String)registro.get("PARRAFO_LETRADO_PROCURADOR")).trim().equals(""))
	...
	public Vector getDesignaCartaAcreditacionOficio(String idInstitucion, String idTurno, String anio, String numero) throws ClsExceptions {
		try {
			...
			h.put(new Integer(3), anio);
			h.put(new Integer(4), numero);
			String sql = "select ACTUACION.FECHA AS ACTUACION_FECHA_ACTUACION, "+
			        " ACTUACION.NUMEROASUNTO AS ACTUACION_NUMEROASUNTO, "+
			        " ACTUACION.NUMERO AS ACTUACION_NUMERO, "+
			        " ACTUACION.ACUERDOEXTRAJUDICIAL AS ACTUACION_ACUERDOEXTRAJUDICIAL, "+
			        " PROCEDIMIENTO_ACTUACION.NOMBRE AS ACTUACION_MODULO, "+
			        " PROCEDIMIENTO_ACTUACION.CODIGO AS ACTUACION_CATEGORIA, "+
			        " PROCEDIMIENTO_ACTUACION.COMPLEMENTO AS ACTUACION_COMPLEMENTO, "+
			        " PROCEDIMIENTO_ACTUACION.IDJURISDICCION AS ACTUACION_IDJURISDICION,"+
			        " ACTUACION.LUGAR AS ACTUACION_LUGAR, "+
			        " ACTUACION.OBSERVACIONESJUSTIFICACION AS ACTUACION_OBSJUSTIFICACION, "+
			        " ACTUACION.OBSERVACIONES AS ACTUACION_OBSERVACIONES, "+
			        " ACTUACION.FECHAJUSTIFICACION AS ACTUACION_FECHAJUSTIFICACION, "+
			        " ACTUACION.FACTURADO AS ACTUACION_FACTURADO, "+
			        " ACTUACION.PAGADO AS ACTUACION_PAGADO, "+
			        " ACTUACION.IDFACTURACION AS ACTUACION_IDFACTURACION, "+
			        " ACTUACION.IDINSTITUCION_PROC AS ACTUACION_IDINSTITUCION_PROC, "+
			        " ACTUACION.TALONARIO AS ACTUACION_TALONARIO, "+
			        " ACTUACION.TALON AS ACTUACION_TALON, "+
			        " ACTUACION.NUMEROPROCEDIMIENTO AS ACTUACION_NUMEROPROCEDIMIENTO, "+
			        " ACTUACION.NIG AS ACTUACION_NIG, "+
			        " ACTUACION.DOCJUSTIFICACION AS ACTUACION_DOCJUSTIFICACION, "+
			        " ACTUACION.ANIOPROCEDIMIENTO AS ACTUACION_ANIOPROCEDIMIENTO, "+
			        " ACTUACION.VALIDADA AS ACTUACION_VALIDADA, "+
			        " ACTUACION.IDPRETENSION AS ACTUACION_IDPROCEDIMIENTO, "+
			        " ACTUACION.ANIO AS ACTUACION_ANIO_DESIGNA, "+
			        " ACTUACION.IDINSTITUCION_JUZG AS ACTUACION_IDINST_JUZGADO, "+
			        " ACTUACION.TALONARIO AS ACTUACION_TALONARIO, "+
			        " ACTUACION.TALON AS ACTUACION_TALON, "+
			        
			        " DESIGNA.RESUMENASUNTO AS DESIGNA_ASUNTO, "+
			        " DESIGNA.NUMPROCEDIMIENTO AS DESIGNA_AUTOS, "+
			        " DESIGNA.CODIGO AS DESIGNA_CODIGO, "+
			        " DESIGNA.FECHAENTRADA AS DESIGNA_FECHA, "+
			        " DESIGNA.FECHAJUICIO AS DESIGNA_FECHAJUICIO, "+
			        " TO_CHAR(DESIGNA.FECHAJUICIO, 'HH24:MI') AS DESIGNA_HORAJUICIO, "+
			        " DESIGNA.FECHAOFICIOJUZGADO AS DESIGNA_FECHAOFICIOJUZGADO, "+
			        " DESIGNA.FECHARECEPCIONCOLEGIO AS DESIGNA_FECHARECEPCIONCOLEGIO, "+
			        " DESIGNA.IDPROCEDIMIENTO AS DESIGNA_IDPROCEDIMIENTO, "+
			        " DESIGNA.NIG AS DESIGNA_NIG, "+
			        " DESIGNA.ANIO || '/' || DESIGNA.CODIGO AS DESIGNA_NOFICIO, "+
			        " DESIGNA.NUMERO AS DESIGNA_NUMERO, "+
			        " DESIGNA.NUMPROCEDIMIENTO AS DESIGNA_NUMPROCEDIMIENTO, "+
			        " DESIGNA.OBSERVACIONES AS DESIGNA_OBSERVACIONES, "+
			        " DESIGNA.DELITOS AS DESIGNA_COMENTARIO_DELITOS, "+
			        " F_SIGA_FECHAENLETRA(DESIGNA.FECHAENTRADA, 'DMA', 1) AS DESIGNA_FECHA_LETRA, "+
			        " f_siga_getrecurso(TIPODESIGNACOLEGIO.DESCRIPCION, 1) AS DESIGNA_DESC_TIPODESIGNA, "+
			        " PROCEDIMIENTO_DESIGNA.NOMBRE AS DESIGNA_PROCEDIMIENTO, "+
			        " PRETENSION_DESIGNA.DESCRIPCION AS DESIGNA_PRETENSION, "+
			        
			        " f_siga_getnombre_persona(ACTUACION.Idpersonacolegiado,0) AS ACTUACION_PERSONA, "+
			        " PRETENSION_ACTUACION.DESCRIPCION AS ACTUACION_PRETENSION, "+
			        " PRISION.NOMBRE AS ACTUACION_PRISION, "+
			        " COMISARIA.NOMBRE AS ACTUACION_COMISARIA, "+
			        " JUZGADO_ACTUACION.NOMBRE AS ACTUACION_JUZGADO, "+
			        " JUZGADO_ACTUACION.CODIGOPOSTAL AS ACTUACION_JUZGADO_CODIGOPOSTAL, "+
			        " JUZGADO_ACTUACION.DOMICILIO AS ACTUACION_JUZGADO_DOMICILIO, "+
			        " JUZGADO_ACTUACION.IDPOBLACION AS ACTUACION_JUZGADO_IDPOBLACION, "+
			        " JUZGADO_ACTUACION.IDPROVINCIA AS ACTUACION_JUZGADO_IDPROVINCIA, "+
			        
			        " JUZGADO_DESIGNA.CODIGOPOSTAL AS DESIGNA_JUZGADO_CP, "+
			        " JUZGADO_DESIGNA.DOMICILIO AS DESIGNA_JUZGADO_DIR, "+
			        " JUZGADO_DESIGNA.IDPOBLACION AS DESIGNA_JUZGADO_IDPOBLACION, "+
			        " JUZGADO_DESIGNA.NOMBRE AS DESIGNA_NOMBRE_JUZGADO, "+
			        
			        
			        " JUZGADOPROCEDIMIENTO.IDINSTITUCION AS ACTUACION_JUZGADOPROCED_IDINST, "+
			        " MOTIVOCAMBIO.NOMBRE AS ACTUACION_MOTIVOCAMBIO, "+
			        
			        
			        " ACREDITACION.DESCRIPCION AS ACREDITACION_DESCRIPCION, "+
			        " ACREDITACIONPROCED.PORCENTAJE AS ACREDITACION_PORCENTAJE, "+
			        "  ACREDITACIONPROCED.NIG_NUMPROCEDIMIENTO AS ACREDITACION_NIG_NUMPROCED, "+
			        
			        " POBLACIONES_ACTUACION.NOMBRE AS ACTUACION_JUZGADO_NOMBREPOBLA, "+
			        " POBLACIONES_DESIGNA.NOMBRE AS DESIGNA_JUZGADO_NOMBREPOBLA, "+
			        " PROVINCIA_DESIGNA.NOMBRE AS DESIGNA_PROVINCIA, "+
			        " TURNO.ABREVIATURA AS ACTUACION_TURNO_ABREV, "+
			        ...
			        " ejgDesigna.Idtipoejg = ejg.idtipoejg and "+
			        " ejgDesigna.Idinstitucion = ejg.idinstitucion and "+
			  ...
			  " from scs_actuaciondesigna ACTUACION "+
			    ...
			    " LEFT JOIN SCS_PRISION PRISION ON ACTUACION.idInstitucion = PRISION.idInstitucion AND PRISION.IDPRISION = ACTUACION.IDPRISION "+
			    " LEFT JOIN SCS_COMISARIA COMISARIA ON ACTUACION.idInstitucion = COMISARIA.idInstitucion AND COMISARIA.IDCOMISARIA = ACTUACION.IDCOMISARIA "+
			    " LEFT JOIN SCS_JUZGADO JUZGADO_ACTUACION ON ACTUACION.idInstitucion = JUZGADO_ACTUACION.idInstitucion AND ACTUACION.IDJUZGADO = JUZGADO_ACTUACION.IDJUZGADO "+
			    " LEFT JOIN SCS_ACREDITACION ACREDITACION ON ACTUACION.IDACREDITACION=ACREDITACION.IDACREDITACION "+
			    " LEFT JOIN SCS_ACREDITACIONPROCEDIMIENTO ACREDITACIONPROCED ON ACTUACION.idInstitucion = ACREDITACIONPROCED.idInstitucion "+
			                                "   AND ACTUACION.IDPROCEDIMIENTO=ACREDITACIONPROCED.IDPROCEDIMIENTO AND ACTUACION.IDACREDITACION = ACREDITACIONPROCED.IDACREDITACION "+
			    " LEFT JOIN SCS_PRETENSION PRETENSION_ACTUACION ON ACTUACION.idInstitucion = PRETENSION_ACTUACION.idInstitucion AND ACTUACION.IDPRETENSION=PRETENSION_ACTUACION.IDPRETENSION "+
			    " LEFT JOIN SCS_ACTUADESIG_MOTCAMBIO MOTIVOCAMBIO ON ACTUACION.idInstitucion = MOTIVOCAMBIO.idInstitucion AND ACTUACION.ID_MOTIVO_CAMBIO=MOTIVOCAMBIO.IDACTDESMOTCAMBIO "+
			    " LEFT JOIN SCS_JUZGADOPROCEDIMIENTO JUZGADOPROCEDIMIENTO ON ACTUACION.idInstitucion = JUZGADOPROCEDIMIENTO.idInstitucion AND ACTUACION.IDPROCEDIMIENTO=JUZGADOPROCEDIMIENTO.IDPROCEDIMIENTO "+
			                                                            "    AND ACTUACION.IDJUZGADO = JUZGADOPROCEDIMIENTO.IDJUZGADO "+
			    " LEFT JOIN CEN_POBLACIONES POBLACIONES_ACTUACION ON JUZGADO_ACTUACION.IDPROVINCIA = POBLACIONES_ACTUACION.IDPROVINCIA AND JUZGADO_ACTUACION.IDPOBLACION = POBLACIONES_ACTUACION.IDPOBLACION "+
			    " LEFT JOIN SCS_TURNO TURNO ON ACTUACION.IDINSTITUCION = TURNO.IDINSTITUCION AND ACTUACION.IDTURNO = TURNO.IDTURNO "+
			    " LEFT JOIN SCS_DESIGNA DESIGNA ON ACTUACION.IDINSTITUCION = DESIGNA.IDINSTITUCION AND ACTUACION.IDTURNO = DESIGNA.IDTURNO AND ACTUACION.ANIO = DESIGNA.ANIO AND ACTUACION.NUMERO = DESIGNA.NUMERO "+
			    " LEFT JOIN SCS_JUZGADO JUZGADO_DESIGNA ON DESIGNA.IDINSTITUCION_JUZG = JUZGADO_DESIGNA.idInstitucion AND DESIGNA.IDJUZGADO = JUZGADO_DESIGNA.IDJUZGADO "+
			    " LEFT JOIN SCS_TIPODESIGNACOLEGIO TIPODESIGNACOLEGIO ON DESIGNA.IDINSTITUCION= TIPODESIGNACOLEGIO.idInstitucion AND DESIGNA.IDTIPODESIGNACOLEGIO = TIPODESIGNACOLEGIO.IDTIPODESIGNACOLEGIO "+
			    " LEFT JOIN CEN_POBLACIONES POBLACIONES_DESIGNA ON JUZGADO_DESIGNA.IDPROVINCIA = POBLACIONES_DESIGNA.IDPROVINCIA AND JUZGADO_DESIGNA.IDPOBLACION = POBLACIONES_DESIGNA.IDPOBLACION "+
			    " LEFT JOIN SCS_PROCEDIMIENTOS PROCEDIMIENTO_DESIGNA ON DESIGNA.idInstitucion = PROCEDIMIENTO_DESIGNA.idInstitucion AND PROCEDIMIENTO_DESIGNA.IDPROCEDIMIENTO = DESIGNA.IDPROCEDIMIENTO "+
