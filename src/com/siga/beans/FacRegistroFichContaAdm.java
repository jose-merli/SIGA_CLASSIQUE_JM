...
//			}
	...
	private java.io.PrintWriter generaAsiento6(java.io.PrintWriter pwcontabilidad, String fechaDesde, String fechaHasta, UserTransaction tx) throws SIGAException, ClsExceptions
	{
		...
		try
		{
			select = " SELECT A.IDABONO IDABONO, B.NUMEROABONO NUMEROABONO, (A.IMPORTE * -1) IMPORTE, B.IDPERSONA IDPERSONA, A.FECHA FECHA, (SELECT '1' FROM FAC_PAGOSPORCAJA PC WHERE PC.IDINSTITUCION=A.IDINSTITUCION AND PC.IDABONO=A.IDABONO AND PC.IDPAGOABONO=A.IDPAGOABONO) AS COMPENSADO " +
			" FROM FAC_PAGOABONOEFECTIVO A , FAC_ABONO B "+
			" WHERE A.IDINSTITUCION = "+this.usrbean.getLocation()+" AND A.IDINSTITUCION = B.IDINSTITUCION AND A.IDABONO = B.IDABONO";
	...
	private java.io.PrintWriter generaAsiento7(java.io.PrintWriter pwcontabilidad, String fechaDesde, String fechaHasta, UserTransaction tx) throws SIGAException, ClsExceptions
	{
		...
		try
		{
			...
			" WHERE A.IDINSTITUCION = "+this.usrbean.getLocation()+" AND A.IDDISQUETEABONO = B.IDDISQUETEABONO AND A.IDINSTITUCION = B.IDINSTITUCION "+
