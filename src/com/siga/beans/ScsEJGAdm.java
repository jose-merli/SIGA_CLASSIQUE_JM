...
//	            "   and A."+ScsEJGBean.C_IDTIPOEJG+"=B."+ScsTipoEJGBean.C_IDTIPOEJG;
			...
			String anio, String numero,String idioma, String idPersonaJG) throws ClsExceptions  
	{
		try {
			...
			sql.append(" DECODE(PERSONAJG.DIRECCION, NULL, NULL, ((SELECT (UPPER(SUBSTR(TV.DESCRIPCION,"+this.usrbean.getLanguage()+", 1, 1))) || (LOWER(SUBSTR(TV.DESCRIPCION, 2))) FROM CEN_TIPOVIA TV WHERE TV.IDTIPOVIA = PERSONAJG.IDTIPOVIA AND TV.IDINSTITUCION = INTERESADO.IDINSTITUCION) || ' ' || PERSONAJG.DIRECCION || ' ' || PERSONAJG.NUMERODIR || ' ' || PERSONAJG.ESCALERADIR || ' ' || PERSONAJG.PISODIR || ' ' || PERSONAJG.PUERTADIR)) AS DOMICILIO_DEFENDIDO, ");
	...
	public Vector getDatosInformeEjg (String idInstitucion, String tipoEjg, String anioEjg, String numeroEjg,String idioma,boolean isSolicitantes,String idPersonaJG) throws ClsExceptions {	 
		Vector vSalida = null;		
