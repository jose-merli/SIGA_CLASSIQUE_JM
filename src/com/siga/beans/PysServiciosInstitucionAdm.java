...
public class PysServiciosInstitucionAdm extends MasterBeanAdministrador {
	...
	/**
	 * Obtiene los datos de un servicio, la diferencia con el anterior procedimiento es que se concatena
	 * el nombre del servicio con el nombre del precio para obtener el concepto
	 * @param idInstitucion
	 * @param idServicio
	 * @param idServicioInstitucion
	 * @param idTipo
	 ...
	 * @throws ClsExceptions, SIGAException
	 */
	public Hashtable getServicioPrecio (Integer idInstitucion, Long idServicio, Long idServicioInstitucion, Integer idTipo) throws ClsExceptions, SIGAException
	{
		try{
			String select = "SELECT " +	
			            UtilidadesMultidioma.getCampoMultidiomaSimple(PysTipoServiciosBean.T_NOMBRETABLA + "." + PysTipoServiciosBean.C_DESCRIPCION ,this.usrbean.getLanguage())+" AS DESCRIPCION_TIPO, " + 
						PysServiciosBean.T_NOMBRETABLA + "." + PysServiciosBean.C_DESCRIPCION  + " AS DESCRIPCION_SERVICIO, " +
						PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_DESCRIPCION + " || " + "' '" + " || " + PysPreciosServiciosBean.T_NOMBRETABLA + "." + PysPreciosServiciosBean.C_DESCRIPCION   + " AS DESCRIPCION_S_INSTITUCION, " +
						PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_PORCENTAJEIVA + ", " +
						PysTipoIvaBean.T_NOMBRETABLA + "." + PysTipoIvaBean.C_VALOR + " AS VALORIVA," +
			...
			String from = " FROM " + 
						PysServiciosInstitucionBean.T_NOMBRETABLA + ", " + PysServiciosBean.T_NOMBRETABLA + ", " + PysTipoServiciosBean.T_NOMBRETABLA+   "," +PysTipoIvaBean.T_NOMBRETABLA + "," + PysPreciosServiciosBean.T_NOMBRETABLA ;
			...
			PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_IDTIPOSERVICIOS + " = " + PysTipoServiciosBean.T_NOMBRETABLA + "." +  PysTipoServiciosBean.C_IDTIPOSERVICIOS+
			" AND "+PysTipoIvaBean.T_NOMBRETABLA+".IDTIPOIVA = "+ PysServiciosInstitucionBean.T_NOMBRETABLA + "." +PysServiciosInstitucionBean.C_PORCENTAJEIVA +
			" and " + PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_IDINSTITUCION + " = " + PysPreciosServiciosBean.T_NOMBRETABLA + "." + PysPreciosServiciosBean.C_IDINSTITUCION + " AND " +
			PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_IDSERVICIO + " = " + PysPreciosServiciosBean.T_NOMBRETABLA + "." + PysPreciosServiciosBean.C_IDSERVICIO + " AND " +
			PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_IDTIPOSERVICIOS + " = " + PysPreciosServiciosBean.T_NOMBRETABLA + "." + PysPreciosServiciosBean.C_IDTIPOSERVICIOS + " AND " +
			PysServiciosInstitucionBean.T_NOMBRETABLA + "." + PysServiciosInstitucionBean.C_IDSERVICIOSINSTITUCION + " = " + PysPreciosServiciosBean.T_NOMBRETABLA + "." + PysPreciosServiciosBean.C_IDSERVICIOSINSTITUCION;
