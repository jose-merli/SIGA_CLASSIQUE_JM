...
public class CenSancionAdm extends MasterBeanAdministrador {
	...
	public String[] getCamposBean() {
		String[] campos = {	CenSancionBean.C_IDSANCION, CenSancionBean.C_IDPERSONA, CenSancionBean.C_IDTIPOSANCION, CenSancionBean.C_REFCOLEGIO, CenSancionBean.C_REFCGAE, CenSancionBean.C_FECHARESOLUCION, CenSancionBean.C_FECHAIMPOSICION,
							CenSancionBean.C_FECHAACUERDO, CenSancionBean.C_FECHAFIRMEZA, CenSancionBean.C_FECHAINICIO, CenSancionBean.C_FECHAFIN, CenSancionBean.C_FECHAREHABILITADO, CenSancionBean.C_TEXTO, CenSancionBean.C_OBSERVACIONES, CenSancionBean.C_IDINSTITUCIONSANCION,CenSancionBean.C_IDINSTITUCION,
							CenSancionBean.C_CHKREHABILITADO, CenSancionBean.C_CHKFIRMEZA,CenSancionBean.C_USUMODIFICACION, CenSancionBean.C_FECHAMODIFICACION};
		return campos;
	}	
