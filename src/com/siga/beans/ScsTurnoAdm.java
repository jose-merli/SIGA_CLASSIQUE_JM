...
//					partidoJudicial.setIdPartido(UtilidadesHash.getInteger(htFila,CenPartidoJudicialBean.C_IDPARTIDO));
	...
	public Vector getTurnosDisponibles(Hashtable hashFiltro,Long idPersona,Integer idInstitucion) throws ClsExceptions{
		...
		String sql = " SELECT SCS_TURNO.IDTURNO IDTURNO, " +
			" SCS_TURNO.NOMBRE NOMBRE, " +
			" SCS_TURNO.ABREVIATURA ABREVIATURA, " +
			" SCS_AREA.NOMBRE AREA, " +
			" SCS_AREA.IDAREA IDAREA, " +
			" SCS_MATERIA.NOMBRE MATERIA, " +
			" SCS_MATERIA.IDMATERIA IDMATERIA, " +
			" SCS_ZONA.NOMBRE ZONA, " +
			" SCS_ZONA.IDZONA IDZONA, " +
			" SCS_SUBZONA.NOMBRE SUBZONA, " +
			" SCS_SUBZONA.IDSUBZONA IDSUBZONA, " +
			" PKG_SIGA_SJCS.FUN_SJ_PARTIDOSJUDICIALES(" + idInstitucion + ", SCS_SUBZONA.IDSUBZONA, SCS_ZONA.IDZONA) PARTIDOS, " +
			" CEN_PARTIDOJUDICIAL.NOMBRE PARTIDOJUDICIAL, " +
			" CEN_PARTIDOJUDICIAL.IDPARTIDO IDPARTIDOJUDICIAL, " +
			...
			UtilidadesMultidioma.getCampoMultidiomaSimple("SCS_GRUPOFACTURACION.NOMBRE", usrbean.getLanguage()) + " GRUPOFACTURACION, " +
			" SCS_GRUPOFACTURACION.IDGRUPOFACTURACION IDGRUPOFACTURACION, " +
			" SCS_TURNO.GUARDIAS GUARDIAS, " +
			" SCS_TURNO.VALIDARJUSTIFICACIONES VALIDARJUSTIFICACIONES, " +
			" SCS_TURNO.VALIDARINSCRIPCIONES VALIDARINSCRIPCIONES, " +
			" SCS_TURNO.DESIGNADIRECTA DESIGNADIRECTA, " +
			" SCS_TURNO.DESCRIPCION DESCRIPCION, " +
			" SCS_TURNO.REQUISITOS REQUISITOS, " +
			" SCS_TURNO.IDPERSONA_ULTIMO IDPERSONAULTIMO, " +
			" SCS_TURNO.FECHASOLICITUD_ULTIMO FECHASOLICITUD_ULTIMO, " +
			" SCS_TURNO.IDORDENACIONCOLAS IDORDENACIONCOLAS, " +
			" SCS_ORDENACIONCOLAS.ALFABETICOAPELLIDOS ALFABETICOAPELLIDOS, " +
			" SCS_ORDENACIONCOLAS.FECHANACIMIENTO EDAD, " +
			" SCS_ORDENACIONCOLAS.NUMEROCOLEGIADO ANTIGUEDAD, " +
			" SCS_ORDENACIONCOLAS.ANTIGUEDADCOLA ANTIGUEDADENCOLA, " +
			" ( " +
				" SELECT COUNT(1) "+
				" FROM SCS_GUARDIASTURNO GT " +
				" WHERE GT.IDINSTITUCION = SCS_TURNO.IDINSTITUCION " +
				" AND GT.IDTURNO = SCS_TURNO.IDTURNO " +
			") NGUARDIAS, "+
		...
		" WHERE SCS_PARTIDAPRESUPUESTARIA.IDINSTITUCION(+) = SCS_TURNO.IDINSTITUCION " +
			...
			" AND SCS_ORDENACIONCOLAS.IDORDENACIONCOLAS = SCS_TURNO.IDORDENACIONCOLAS " +
			" AND SCS_TURNO.IDINSTITUCION = " + idInstitucion +
			" AND SCS_TURNO.IDTURNO NOT IN ( " +
				" SELECT TU.IDTURNO " +
				" FROM SCS_INSCRIPCIONTURNO TU " +
				" WHERE TU.IDPERSONA = " + idPersona +
					" AND TU.IDINSTITUCION = " + idInstitucion + 
					" AND TU.FECHABAJA IS NULL " +
					" AND (TU.FECHADENEGACION IS NULL OR TU.FECHAVALIDACION IS NOT NULL) " +
			" ) ";
