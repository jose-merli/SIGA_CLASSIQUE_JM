...
public class ScsDocumentacionEJGBean extends MasterBean{
	...
	static public final String 	C_IDPRESENTADORMAESTRO 	= 			"IDMAESTROPRESENTADOR";
	 ...
	 * 
	 * @param valor
	 *            Identificador tipo EJG
	 * @return void
	 */
	public void setIdTipoEJG(Integer valor) {
		this.idTipoEJG = valor;
	}
	 ...
	 * @return void
	 */
	public void setDocumentacion(String valor) {
	 ...
	 * 
	 * @param valor
	 *            Identificador documentación EJG
	 * @return void
	 */
	public void setIdDocumentacion(Integer valor) {
		this.idDocumentacion = valor;
	}
	 ...
	 * 
	 * @param valor
	 *            Fecha límite entrega documentación EJG
	 * @return void
	 */
	public void setFechaLimite(String valor) {
		this.fechaLimite = valor;
	}
