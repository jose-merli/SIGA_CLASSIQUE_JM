...
public class ExpAnotacionAdm extends MasterBeanAdministrador {
	...
	public Vector getAnotacionesExpediente(ExpSeguimientoForm form , UsrBean user) throws ClsExceptions 
	{
	    	...
	    	try {
				...
				sql += " " + where;
				sql += " ORDER BY TRUNC (A."+ExpAnotacionBean.C_FECHAANOTACION+"), A."+ExpAnotacionBean.C_IDANOTACION+", 1, F."+ExpFasesBean.C_NOMBRE+", E."+ExpEstadosBean.C_NOMBRE+", T."+ExpTiposAnotacionesBean.C_NOMBRE;
