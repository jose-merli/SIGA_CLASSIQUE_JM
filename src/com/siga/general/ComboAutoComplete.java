				...
				if (registro != null) { 
					...
					if (tieneCampoPrioridad)  {
						...
						if(bGuiones&&bPrioridad&&prioridad==null) {
							...
							sHtml+="<option value=''>"+guiones+"</option>";
					...
					if (!bSeleccionado && UtilidadesHash.getInteger(registro, "SELECCIONADO")==0) {
						bSeleccionado=true;
						//arrayHtml.add("<option selected value='"+UtilidadesHash.getString(registro, campoIdentificador)+"'>"+UtilidadesHash.getString(registro, campoNombre)+"</option>");
						sHtml+="<option selected value='"+UtilidadesHash.getString(registro, campoIdentificador)+"'>"+UtilidadesHash.getString(registro, campoNombre)+"</option>";
					}
					else {
						//arrayHtml.add("<option value='"+UtilidadesHash.getString(registro, campoIdentificador)+"'>"+UtilidadesHash.getString(registro, campoNombre)+"</option>");
						sHtml+="<option value='"+UtilidadesHash.getString(registro, campoIdentificador)+"'>"+UtilidadesHash.getString(registro, campoNombre)+"</option>";
					}
