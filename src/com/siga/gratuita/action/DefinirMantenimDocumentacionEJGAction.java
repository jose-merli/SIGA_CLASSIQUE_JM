...
protected ActionForward executeInternal (ActionMapping mapping,
	...
	protected String buscarPor(ActionMapping mapping, MasterForm formulario, HttpServletRequest request, HttpServletResponse response) throws SIGAException {		
		...
		sql=sql+"   t.idinstitucion = "+usr.getLocation()+
				...
				" order by translate(upper(ABREVIATURATIPO),'ÁÉÍÓÚÀÈÌÒÙÄËÏÖÜ','AEIOUAEIOUAEIOU'),translate(upper(descripciontipo),'ÁÉÍÓÚÀÈÌÒÙÄËÏÖÜ','AEIOUAEIOUAEIOU'),translate(upper(ABREVIATURADOCU),'ÁÉÍÓÚÀÈÌÒÙÄËÏÖÜ','AEIOUAEIOUAEIOU'),translate(upper(DESCRIPCIONDOCU),'ÁÉÍÓÚÀÈÌÒÙÄËÏÖÜ','AEIOUAEIOUAEIOU')";
