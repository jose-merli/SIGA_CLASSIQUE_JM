		...
		try {
		    ...
		    if (request.getSession().getAttribute("DATAPAGINADOR")!=null){ 
			 ...
			 if (paginador!=null){	
				...
				Vector datos = null;
				Hashtable htConsultaBind  = admBean.getBindBusquedaMantenimientoEJG(miHash,  miForm,true);
	...
	protected String buscarPorOld(ActionMapping mapping, MasterForm formulario, HttpServletRequest request, HttpServletResponse response) throws SIGAException {
		...
		try {
			...
			if (request.getSession().getAttribute("DATAPAGINADOR") != null) {
				 ...
				 */
				consulta = "select ejg." + ScsEJGBean.C_ANIO +
						" , ejg." + ScsEJGBean.C_IDINSTITUCION +
						" , ejg." + ScsEJGBean.C_IDTIPOEJG +
						" , ejg." + ScsEJGBean.C_IDFACTURACION +
						" , ejg. "	+ ScsEJGBean.C_FECHARATIFICACION +
						" ,  " + UtilidadesMultidioma.getCampoMultidiomaSimple("tipoejg." + ScsTipoEJGBean.C_DESCRIPCION, this.getUserBean(request).getLanguage())	+ " as TIPOEJG" +
						" , ejg."	+ ScsEJGBean.C_NUMEJG +
						" , ejg."	+ ScsEJGBean.C_FECHAAPERTURA +
						" , f_siga_getnombreturno( ejg." + ScsEJGBean.C_IDINSTITUCION +
						" , ejg." + ScsEJGBean.C_GUARDIATURNO_IDTURNO + ") as TURNO" +
						" , ejg." + ScsEJGBean.C_GUARDIATURNO_IDTURNO +
						" , guardia." + ScsGuardiasTurnoBean.C_NOMBRE + " as GUARDIA" +
						" , f_siga_getunidadejg(ejg.idinstitucion,ejg.anio,ejg.numero,ejg.idtipoejg) AS NOMBRE, '' AS APELLIDO1,'' AS APELLIDO2" +
						", (select " + UtilidadesMultidioma.getCampoMultidioma("maestroes." + 
								ScsMaestroEstadosEJGBean.C_DESCRIPCION, this.getUserBean(request).getLanguage()) + "" +						
						" from " + ScsEstadoEJGBean.T_NOMBRETABLA + " estadoejg," + ScsMaestroEstadosEJGBean.T_NOMBRETABLA + " maestroes" +
						" WHERE estadoejg." + ScsEstadoEJGBean.C_IDINSTITUCION + " = ejg." + ScsEJGBean.C_IDINSTITUCION +
						" and estadoejg." + ScsEstadoEJGBean.C_IDTIPOEJG + " = ejg." + ScsEJGBean.C_IDTIPOEJG
						...
						ScsEstadoEJGBean.C_NUMERO + " = estadoejg." + ScsEstadoEJGBean.C_NUMERO + ") and rownum=1) as estado, ejg." + ScsEJGBean.C_NUMERO
						+ ",ejg." + ScsEJGBean.C_FECHAMODIFICACION + "";

				String from = " from " + ScsEJGBean.T_NOMBRETABLA + " ejg," + ScsGuardiasTurnoBean.T_NOMBRETABLA + " guardia" +
						"," + ScsTipoEJGBean.T_NOMBRETABLA + " tipoejg," + CenColegiadoBean.T_NOMBRETABLA + " colegiado";

				consulta += from;

				/* realizamos la join con de las tablas que necesitamos */

				consulta += " where ejg." + ScsEJGBean.C_IDTIPOEJG + " = tipoejg." + ScsTipoEJGBean.C_IDTIPOEJG + " and " +

				" ejg." + ScsEJGBean.C_IDINSTITUCION + " = guardia." + ScsGuardiasTurnoBean.C_IDINSTITUCION + "(+) and " +

				" ejg." + ScsEJGBean.C_GUARDIATURNO_IDTURNO + " = guardia." + ScsGuardiasTurnoBean.C_IDTURNO + "(+) and " +

				" ejg." + ScsEJGBean.C_GUARDIATURNO_IDGUARDIA + " = guardia." + ScsGuardiasTurnoBean.C_IDGUARDIA + "(+) and " +
				...
				" AND (ejg." + ScsEJGBean.C_IDINSTITUCION + ",ejg." +ScsEJGBean.C_IDTIPOEJG + ",ejg." + ScsEJGBean.C_ANIO + ",ejg."+ScsEJGBean.C_NUMERO + ") " +
				" NOT IN (SELECT " + ScsEstadoEJGBean.C_IDINSTITUCION + "," + ScsEstadoEJGBean.C_IDTIPOEJG + ", " + ScsEstadoEJGBean.C_ANIO + ", " + ScsEstadoEJGBean.C_NUMERO +
				" FROM " + ScsEstadoEJGBean.T_NOMBRETABLA + " WHERE " + ScsEstadoEJGBean.C_IDESTADOEJG + " IN (7,8,9,10,11)) ";//7=Listo remitir comision,8=Genarado en remesa,9=Remitido comisión,10=Resuelto comision,11=Impugnado
				...
				if ((miHash.containsKey("ESTADOEJG")) && (!miHash.get("ESTADOEJG").toString().equals(""))) {
					...
					if (UtilidadesHash.getString(miHash, "NUMEJG") != null && !UtilidadesHash.getString(miHash, "NUMEJG").equalsIgnoreCase("")) {
						...
						if (ComodinBusquedas.hasComodin(UtilidadesHash.getString(miHash, "NUMEJG")))
							...
							consulta += " AND "
									+ ComodinBusquedas.prepararSentenciaCompleta(((String) UtilidadesHash.getString(miHash, "NUMEJG")).trim(), "ejg.NUMEJG");

						else

						if (UtilidadesHash.getInteger(miHash, "NUMEJG") != null) {

							consulta += " AND ejg.NUMEJG  = " + (String) UtilidadesHash.getString(miHash, "NUMEJG");
					...
					if ((miHash.containsKey("IDINSTITUCION")) && (!miHash.get("IDINSTITUCION").toString().equals("")))
				     ...
				     if ((miHash.containsKey("NIF")) && (!miHash.get("NIF").toString().equals(""))){
		                 // RGG quitamos like delante NIF  codigos.put(new Integer(contador),"%"+((String)miHash.get("NIF")).trim()+"%");
		                 //codigos.put(new Integer(contador),((String)miHash.get("NIF")).trim()+"%");
						 //consulta += " and UPPER (f_siga_getnifunidadejg(ejg.idinstitucion, ejg.anio, ejg.numero,ejg.idtipoejg))LIKE UPPER(:"+contador+")";
					 	consulta += " and UPPER('"+((String)miHash.get("NIF")).trim()+"') in ( select upper(pjg.nif) as person " + 
				     ...
				     if (
				        ...
				        if ((miHash.containsKey("NOMBRE")) && (!miHash.get("NOMBRE").toString().equals(""))){
					        ...
					        consulta += " and UPPER('"+((String)miHash.get("NOMBRE")).trim()+"') in ( select upper(pjg.nombre) as person " + 
					        		"	from SCS_UNIDADFAMILIAREJG unidad, SCS_EJG EJG2, scs_personajg PJG " + 
					        		"	where  unidad.idinstitucion = pjg.idinstitucion " +
					        		"	and unidad.idpersona = pjg.idpersona " +
					        		"	and ejg2.IDINSTITUCION = unidad.IDINSTITUCION(+) " +
				        ...
				        if ((miHash.containsKey("APELLIDO1")) && (!miHash.get("APELLIDO1").toString().equals(""))){
					        ...
					        consulta += " and UPPER('"+((String)miHash.get("APELLIDO1")).trim()+"') in ( select upper(pjg.apellido1) as person " + 
					        		"	from SCS_UNIDADFAMILIAREJG unidad, SCS_EJG EJG2, scs_personajg PJG " + 
					        		"	where  unidad.idinstitucion = pjg.idinstitucion " +
					        		"	and unidad.idpersona = pjg.idpersona " +
					        		"	and ejg2.IDINSTITUCION = unidad.IDINSTITUCION(+) " +
				        ...
				        if ((miHash.containsKey("APELLIDO2")) && (!miHash.get("APELLIDO2").toString().equals(""))){
					        ...
					        consulta += " and UPPER('"+((String)miHash.get("APELLIDO2")).trim()+"') in ( select upper(pjg.apellido2) as person " + 
					        		"	from SCS_UNIDADFAMILIAREJG unidad, SCS_EJG EJG2, scs_personajg PJG " + 
					        		"	where  unidad.idinstitucion = pjg.idinstitucion " +
					        		"	and unidad.idpersona = pjg.idpersona " +
					        		"	and ejg2.IDINSTITUCION = unidad.IDINSTITUCION(+) " +
...
//				        contador++;
//				        codigos.put(new Integer(contador),"%"+vDatosSolicitante.trim()+"%");
//				        consulta += " and UPPER (f_siga_getunidadejg(ejg.idinstitucion, ejg.anio, ejg.numero,ejg.idtipoejg))LIKE UPPER(:"+contador+")";
					...
					if ((miHash.containsKey("PROCEDIMIENTO")) && (!miHash.get("PROCEDIMIENTO").toString().equals("")))
						...
						consulta += " and "
								+ ComodinBusquedas.prepararSentenciaCompleta(((String) miHash.get("PROCEDIMIENTO")).trim(), "ejg.numeroprocedimiento");

					if ((miHash.containsKey("CALIDAD")) && (!miHash.get("CALIDAD").toString().equals("")))

						consulta += " and " + ComodinBusquedas.prepararSentenciaCompleta(((String) miHash.get("CALIDAD")).trim(), "ejg.calidad");

					consulta = "SELECT " + ScsEJGBean.C_ANIO + ", " + ScsEJGBean.C_IDINSTITUCION + ", " + ScsEJGBean.C_IDTIPOEJG + ", TIPOEJG," +

					ScsEJGBean.C_NUMERO + ", " + ScsEJGBean.C_NUMEJG + ", " + ScsEJGBean.C_FECHAAPERTURA + ", TURNO, GUARDIA, ESTADO, "
							+ ScsPersonaJGBean.C_NOMBRE + ", " +

							ScsPersonaJGBean.C_APELLIDO1 + ", " + ScsPersonaJGBean.C_APELLIDO2 + "," + ScsEJGBean.C_FECHAMODIFICACION + " from (" + consulta
							+ ") where estado = '" + miHash.get("DESCRIPCIONESTADO") + "'";

					// Criterio de ordenación

					// consulta += " ORDER BY " + ScsEJGBean.C_FECHAAPERTURA + "
					// DESC";
					...
					// Consulta sobre el campo NIF/CIF, si el usuario mete
					// comodines la búsqueda es como se hacía siempre, en el
					// caso

					// de no meter comodines se ha creado un nuevo metodo
					// ComodinBusquedas.preparaCadenaNIFSinComodin para que
					// monte
...
//				        consulta += " and UPPER (f_siga_getunidadejg(ejg.idinstitucion, ejg.anio, ejg.numero,ejg.idtipoejg))LIKE UPPER(:"+contador+")";
					...
					if ((miHash.containsKey("CALIDAD")) && (!miHash.get("CALIDAD").toString().equals("")))
						...
						consulta += " and ejg.calidad  = '" + (String) UtilidadesHash.getString(miHash, "CALIDAD") + "' ";
...
//			}
	...
	protected String abrirAvanzada(ActionMapping mapping, MasterForm formulario, HttpServletRequest request, HttpServletResponse response) throws SIGAException {
		...
		// Ejecutamos el PL para obtener los letrados a los que asignarles un EJG
        ...
        if (Integer.parseInt(contador) == 0){
            ...
            //throw new SIGAException("Error en DefinirCalendarioGuardiaAction.insertarCalendarioAutomaticamente()");                          //Si tengo letrados borro y genero el calendario
        } else {
        	try 
			{								
	        	//Buscamos los datos necesarios para los letrados obtenidos a traves del contador.
	            //Los insertamos en un Vector de Hash
	            consulta = " SELECT " + GenClientesTemporalBean.C_IDPERSONA + " FROM " + GenClientesTemporalBean.T_NOMBRETABLA + " WHERE " + GenClientesTemporalBean.C_IDINSTITUCION + " = " + idinstitucion + " AND " + GenClientesTemporalBean.C_CONTADOR + " = " + contador;			
	            ...
	            // Almacenamos el IDPERSONA del letrado en la sesión para recuperarlo posteriormente 
