...
//								iteResultado.remove();
			...
			throws SIGAException
	{
		...
		try
		{
			...
			if (ocultos!=null)hashPestanha.put(ScsGuardiasTurnoBean.C_IDGUARDIA,(String)ocultos.get(1));
			else hashPestanha.put(ScsGuardiasTurnoBean.C_IDGUARDIA,(String)miForm.getGuardia());
