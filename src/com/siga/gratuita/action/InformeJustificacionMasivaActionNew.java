...
import com.siga.gratuita.form.InformeJustificacionMasivaFormNew;
import com.siga.informes.MasterWords;


public class InformeJustificacionMasivaActionNew extends MasterAction {
	...
	protected String inicioInforme (ActionMapping mapping, 		
			...
			{
		InformeJustificacionMasivaFormNew form = (InformeJustificacionMasivaFormNew) formulario;
		form.clear();
...
//		UserTransaction tx = null;
		...
		try {
			InformeJustificacionMasivaFormNew miForm = (InformeJustificacionMasivaFormNew) formulario;
...
//		ReadProperties rp3 = new ReadProperties("SIGA.properties");
	...
	protected String buscarPor(ActionMapping mapping, MasterForm formulario,
		...
		InformeJustificacionMasivaFormNew f = (InformeJustificacionMasivaFormNew) formulario;
...
//	ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ					List<DesignaForm> designaList = admDesignas.getDesignaList(f, designaHashtable,null, false);
						List<DesignaForm> designaList = null;
...
//				ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ PaginadorBind paginador = admDesignas.getDesignasJustificacionPaginador(f,false);
				...
				if (paginador!=null&& paginador.getNumeroTotalRegistros()>0){
					...
					for (int i = 0; i < datos.size(); i++) {
						Row designaRow = (Row)datos.get(i);
						Hashtable designaHashtable = (Hashtable) designaRow.getRow();
//						ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ List<DesignaForm> designaList = admDesignas.getDesignaList(f, designaHashtable,null, false);
						List<DesignaForm> designaList = null;
						designaFormList.addAll(designaList);
					}
					request.setAttribute("designaFormList", designaFormList);
...
//			ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ Hashtable htPersonas = admDesignas.getPersonasSalidaInformeJustificacion(f,true);
			Hashtable htPersonas = null;
