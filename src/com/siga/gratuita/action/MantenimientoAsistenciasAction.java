...
public class MantenimientoAsistenciasAction extends MasterAction 
{
				...
				HttpServletResponse response) throws SIGAException 
    {
		...
		String select = "SELECT  A.IDTURNO IDTURNO, C.IDGUARDIA IDGUARDIA, "+
							...
							" F_SIGA_GETRECURSO(F_SIGA_GET_ULTIMOESTADOEJG("+ usr.getLocation() +", G.IDTIPOEJG, F.ANIO, F.NUMERO), 1) NOMBREESTADOEJG," +
							...
							" I.APELLIDOS2 APELLIDO2LETRADO, I.IDPERSONA IDPERSONACOLEGIADO, NVL(H.NCOLEGIADO,H.NCOMUNITARIO) NUMEROCOLEGIADO, D.CODIGO CODIGO, " +
