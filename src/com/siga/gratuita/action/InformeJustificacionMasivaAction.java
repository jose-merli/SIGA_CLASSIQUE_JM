...
//		ReadProperties rp3 = new ReadProperties("SIGA.properties");
	...
	throws ClsExceptions, SIGAException {
		...
		try {
			...
			Vector plantillas = this.obtenerPlantillasFormulario("JUSDE",idInstitucion.toString(), usr);
					...
					while (itePersonas.hasNext()) {
						...
						while (itRowsDesigna.hasNext()) {
							...
							for(DesignaForm designaForm:designaList){
								...
								String expedientes = getExpediente(designaForm.getExpedientes());
								htRowDesigna.put("EXPEDIENTES", expedientes);
								if(!designaForm.getPermitidoJustificar()&&f.isActivarRestriccionesFicha()){
									String acreditacion = "";
									...
									if( tipoResolucionDesigna.equals(admDesignas.resolucionDesignaNoFavorable)){
										acreditacion = UtilidadesString.getMensajeIdioma(usr,"gratuita.informeJustificacionMasiva.resolucionDesignaNoFavorable");
									}else if( tipoResolucionDesigna.equals(admDesignas.resolucionDesignaSinResolucion)){
										acreditacion = UtilidadesString.getMensajeIdioma(usr,"gratuita.informeJustificacionMasiva.resolucionDesignaSinResolucion");
										
									}else if( tipoResolucionDesigna.equals(admDesignas.resolucionDesignaPteCAJG)){
										acreditacion = UtilidadesString.getMensajeIdioma(usr,"gratuita.informeJustificacionMasiva.resolucionDesignaPteCAJG");
									}else if( tipoResolucionDesigna.equals(admDesignas.resolucionDesignaSinEjg)){
										acreditacion = UtilidadesString.getMensajeIdioma(usr,"gratuita.informeJustificacionMasiva.resolucionDesignaSinEjg");
...
//			throwExcp(e.getMessage(),new String[] {"modulo.informes"},e,null);
	...
	private Vector obtenerPlantillasFormulario(String idTipoInforme, String idInstitucion, UsrBean usr) throws ClsExceptions {
	    Vector salida = null;
	    try {
		    AdmInformeAdm adm = new AdmInformeAdm(usr);
		    salida = adm.obtenerInformesTipo(idInstitucion,idTipoInforme,null,null);
