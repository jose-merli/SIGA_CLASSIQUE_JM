...
//			tx.begin();
			...
			solicitarAlta(new Integer(form.getIdInstitucion()),
...
//		UserTransaction tx = null;
		...
		// JPT: He eliminado la comprobación de la validacion automatica, ya que se realiza en GestionInscripcionesTGAction.preAltaTurno
