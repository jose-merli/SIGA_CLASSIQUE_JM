...
*/
 public class DefinirDictamenEJGForm extends MasterForm{
	...
	/**
	 * Almacena en la Hashtable el identificador del fundamento de calificacion
	 * 
	...
	public String getIdDictamen 					()		{ return this.datos.get(ScsEJGBean.C_IDDICTAMEN).toString();}
	/**
	...
	/**
	 * Recupera de la Hashtable el identificador del fundamento de calificacion
	 * 
	 * @return Observaciones de la EJG
	 */
