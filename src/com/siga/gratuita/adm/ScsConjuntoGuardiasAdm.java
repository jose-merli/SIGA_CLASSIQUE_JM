...
public class ScsConjuntoGuardiasAdm extends MasterBeanAdministrador{
	...
	protected String[] getCamposBean() {
		String[] campos = { ScsConjuntoGuardiasBean.C_IDINSTITUCION, ScsConjuntoGuardiasBean.C_IDCONJUNTOGUARDIA, ScsConjuntoGuardiasBean.C_DESCRIPCION, ScsConjuntoGuardiasBean.C_FECHAMODIFICACION, ScsConjuntoGuardiasBean.C_USUMODIFICACION
	...
	protected String[] getClavesBean() {
		String[] claves = { ScsConjuntoGuardiasBean.C_IDCONJUNTOGUARDIA, ScsConjuntoGuardiasBean.C_IDINSTITUCION };
		return claves;
	}

	protected String[] getOrdenCampos() {
		String[] orden = { ScsConjuntoGuardiasBean.C_DESCRIPCION };
		return orden;
	}
	...
	public List<ConjuntoGuardiasForm> getConjuntosGuardia(String idInstitucion, boolean conCargaMasiva) throws ClsExceptions {
		...
		if(!conCargaMasiva) {
			sql.append(" AND I.IDCONJUNTOGUARDIA <> 0");
		}
	...
	public ScsConjuntoGuardiasBean getUltimoConjuntoGuardiaInsertado(String idInstitucion) throws ClsExceptions {
		...
		try {
			...
			if (rc.findBind(sql.toString(), codigosHashtable)) {
				...
				throw new ClsExceptions("Error al buscar getUltimoConjuntoGuardiaInsertado");
		} catch (Exception e) {
			throw new ClsExceptions(e, "Error al ejecutar consulta.");
		}
