...
import org.redabogacia.www.pjgpra.wspjgpra.SolicitudPeticionInfoAAPP.DatosAmpliadosPeticionInfoAAPP;
import org.redabogacia.www.pjgpra.wspjgpra.SolicitudPeticionInfoAAPP.DatosContacto;
import org.redabogacia.www.pjgpra.wspjgpra.SolicitudPeticionInfoAAPP.DatosDireccionSolicitante;
import org.redabogacia.www.pjgpra.wspjgpra.SolicitudPeticionInfoAAPP.DatosPeticionInfoAAPP;
import org.redabogacia.www.pjgpra.wspjgpra.SolicitudPeticionInfoAAPP.DatosProcedimiento;
...
public class SolicitudesEEJG {
	...
	private static final Logger logger = Logger.getLogger(SolicitudesEEJG.class);
	...
	private DatosProcedimiento getDatosProcedimiento(ScsEejgPeticionesBean scsEejgPeticionesBean,UsrBean usrBean)throws Exception{
		...
		if(defensaJuridicaHashtable.get("DECLARANTE")!=null)
			datosProcedimiento.setDeclarante((String)defensaJuridicaHashtable.get("DECLARANTE"));
		...
		if(defensaJuridicaHashtable.get("NUMPROCEDIMINETO")!=null)
			datosProcedimiento.setNumeroProcedimiento((String)defensaJuridicaHashtable.get("NUMPROCEDIMINETO"));
	...
	public String solicitudPeticionInfoAAPP(ScsEejgPeticionesBean scsEejgPeticionesBean) throws Exception {
		...
		Informacion informacion = null;//new Informacion(datosPeticionInfoAAPP,datosAmpliadosPeticionInfoAAPP);
