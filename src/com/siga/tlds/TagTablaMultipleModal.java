...
*/			
			...
			out.println("<input type=\"hidden\" name=\"tablaDatosDinamicosD" + this.nombre + "\">");
			...
			out.println("   datos = document.getElementById('tablaDatosDinamicosD" + this.nombre + "');");
			...
			out.println("          var aux = 'oculto' + fila + '_' + j + '_' + '" + this.nombre + "';");
