...
public class PCAJGGeneralitatValencianaEnvioEJG extends SIGAWSClientAbstract {

	private static Logger log = Logger.getLogger(PCAJGGeneralitatValencianaEnvioEJG.class);
