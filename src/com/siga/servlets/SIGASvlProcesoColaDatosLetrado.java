...
public final class SIGASvlProcesoColaDatosLetrado extends SIGAContextListenerAdapter implements NotificationListener 
{
    private Timer timer;
    private Integer idNotificacion;
    private long lIntervalo = 1;
    private String sNombreProceso = "ProcesoColaDatosLetrado";
...
//        ReadProperties properties=new ReadProperties("SIGA.properties");
    ...
    public void handleNotification(Notification notif, Object handback)
    {
		...
		try
		{
		    ...
		    CenColaCambioLetradoAdm admCola = new CenColaCambioLetradoAdm (us); // Este esta controlado
		    
		    admCola.chequearCola();
