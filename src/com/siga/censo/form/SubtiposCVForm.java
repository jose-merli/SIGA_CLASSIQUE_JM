...
public class SubtiposCVForm extends MasterForm {
	...
	/**
	 * @return the idTipoCVBusqueda
	 */
	public String getIdTipoCVBusqueda() {
		return idTipoCVBusqueda;
	}
	/**
	 * @param idTipoCVBusqueda the idTipoCVBusqueda to set
	 */
