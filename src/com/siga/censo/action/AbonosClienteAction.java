...
public class AbonosClienteAction extends MasterAction {
	 ...
	 * @exception  SIGAException  En cualquier caso de error
	 */
	protected String abrirAbonosPaginados(ActionMapping mapping, MasterForm formulario, HttpServletRequest request, HttpServletResponse response) throws SIGAException {
	...
	protected String imprimir(ActionMapping mapping, MasterForm formulario, HttpServletRequest request, HttpServletResponse response) throws SIGAException {
		...
		try {
			...
			if (databackup != null) {
				...
				if(tipoFichaColegial != null && tipoFichaColegial.equals("SJCS")){
					cabeceras = new String[8];
					cabeceras[0] = "FECHA";
					cabeceras[1] = "NUMEROABONO";
					cabeceras[2] = "OBSERVACIONES";
					cabeceras[3] = "IMPORTE_BRUTO";
					cabeceras[4] = "MOV_VARIOS";
					cabeceras[5] = "RETENCIONES_JUDICIALES";
					cabeceras[6] = "IRPF";
					cabeceras[7] = "IMPORTE_NETO";
					...
					for (int i = 0; i < datos.size(); i++) {
						...
						UtilidadesHash.set(filaHashtable, "IMPORTE_NETO", UtilidadesNumero.formatoCampo(UtilidadesNumero.redondea((String)filaHashtable.get("TOTALNETO"), 2)));
						UtilidadesHash.set(filaHashtable, "IMPORTE_BRUTO", UtilidadesNumero.formatoCampo(UtilidadesNumero.redondea((String)filaHashtable.get("TOTAL_BRUTO"), 2)));
						UtilidadesHash.set(filaHashtable, "MOV_VARIOS", UtilidadesNumero.formatoCampo(UtilidadesNumero.redondea((String)filaHashtable.get("MOV_VARIOS"), 2)));
						UtilidadesHash.set(filaHashtable, "IRPF", UtilidadesNumero.formatoCampo(UtilidadesNumero.redondea((String)filaHashtable.get("IRPF"), 2)));
						UtilidadesHash.set(filaHashtable, "RETENCIONES_JUDICIALES", UtilidadesNumero.formatoCampo(UtilidadesNumero.redondea((String)filaHashtable.get("RET_JUDICIAL"), 2)));
					}
