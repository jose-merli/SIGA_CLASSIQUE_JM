...
public class RespuestaSolSusProcedimientoServiceImpl extends MyBatisBusinessServiceTemplate	implements RespuestaSolSusProcedimientoService {
	
	public RespuestaSolSusProcedimientoServiceImpl(BusinessManager businessManager) {
