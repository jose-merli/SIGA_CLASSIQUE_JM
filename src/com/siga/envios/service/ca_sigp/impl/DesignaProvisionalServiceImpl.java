...
public class DesignaProvisionalServiceImpl extends MyBatisBusinessServiceTemplate	implements DesignaProvisionalService
	 {
	...
	public DesignaProvisionalServiceImpl(BusinessManager businessManager) {
...
//		EcomDesignaprovisionalWithBLOBs	ecomDesignaprovisionalWithBLOBs = ecomDesignaprovisionalMapper.selectByPrimaryKey(new BigDecimal(idIntercambio));
		...
		ecomDesignaprovisionalWithBLOBs.setLogerror("");
		ecomDesignaprovisionalWithBLOBs.setXml("");
		ecomDesignaprovisionalWithBLOBs.setFechapeticion(Calendar.getInstance().getTime());
		ecomDesignaprovisionalWithBLOBs.setFechamodificacion(Calendar.getInstance().getTime());
		...
		ecomDesignaprovisionalMapper.insertSelective(ecomDesignaprovisionalWithBLOBs);
		...
		enviosKey.setIdenvio(ecomDesignaprovisionalWithBLOBs.getIdenvio());
		enviosKey.setIdinstitucion(ecomDesignaprovisionalWithBLOBs.getIdinstitucion());
