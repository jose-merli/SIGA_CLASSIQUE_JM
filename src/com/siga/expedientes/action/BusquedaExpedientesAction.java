		...
		try {
			...
			for (int i = 0; i < form.getDatosTabla().size(); i++) {
				Vector vCampos = form.getDatosTablaOcultos(i);
					...
					datos.addAll(expedienteAdm.getDatosInformeExpediente(idInstitucion, idInstitucionTipoExp, idTipoExp, anio, numero, null, false));
	        ...
	        String[] campos = null;
				...
				cabeceras = new String[]{"INSTITUCION",
						"TIPO EXPEDIENTE",
						"INSTITUCION EXPEDIENTE",
						"NUMERO EXPEDIENTE",
						"AÑO EXPEDIENTE",
						"FASE",
						"ESTADO",
				...
				campos = new String[]{ExpExpedienteBean.C_IDINSTITUCION,"TE_NOMBRE",ExpExpedienteBean.C_IDINSTITUCION_TIPOEXPEDIENTE,
						ExpExpedienteBean.C_NUMEROEXPEDIENTE,ExpExpedienteBean.C_ANIOEXPEDIENTE,"FASE_NOMBRE","EST_NOMBRE","FECHA","PER_NOMBRE","PER_APELLIDOS1","PER_APELLIDOS2"};
