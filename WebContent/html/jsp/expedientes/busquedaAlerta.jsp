...
<body onload="ajusteAlto('resultado');recargarCombos();<%=funcionBuscar%>">
		...
		<fieldset>
			<table class="tablaCampos" align="center"">
				<tr>
					...
					<td>
						<html:text name="busquedaAlertaForm" property="anioExpediente" style="width:40px;" maxlength="4" styleClass="box"></html:text>&nbsp;/&nbsp;<html:text name="busquedaAlertaForm" property="numeroExpediente" style="width:60px;" maxlength="6" styleClass="box" />
					</td>
				</tr>
	...
	<iframe align="middle" src="<%=app%>/html/jsp/general/blank.jsp" id="resultado" name="resultado" scrolling="no" frameborder="0" marginheight="0" marginwidth="0" class="frameGeneral"></iframe>
