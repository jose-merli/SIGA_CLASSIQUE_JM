	...
	<siga:ConjCampos leyenda="expedientes.auditoria.literal.anotacion">
		...
		<tr>
			...
			<td>
				...
				%>
					<siga:Datepicker nombreCampo="fechaFinEstado" posicionY="100" posicionX="200"></siga:Datepicker>
				<%}else{%>
		...
		<tr>
			...
			<td>
				...
				%>
					...
					<siga:Datepicker nombreCampo="fecha" posicionY="100" posicionX="200"></siga:Datepicker>
				<%}else{%>
