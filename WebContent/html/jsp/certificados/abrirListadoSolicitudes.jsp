...
<%
	...
	SIGASolicitudesCertificadosForm formulario = (SIGASolicitudesCertificadosForm)request.getAttribute("SolicitudesCertificadosForm");
	...
	<body onload="ajusteAltoBotones('resultado');inicio();">
			...
			<table class="tablaCentralCampos" align="center" border="0">
				<html:form action="/CER_GestionSolicitudes.do?noReset=true" method="POST" target="resultado">
					...
					<tr>
						<td class="labelText">
							<siga:Idioma key="certificados.solicitudes.literal.fechadesde"/>
						</td>
						<td>
						...
						<td class="labelText">
							<siga:Idioma key="certificados.solicitudes.literal.estadosolicitud"/>
						</td>
						<td>
					...
					<tr>
						...
						<td >
							<siga:ComboBD nombre="tipoCertificado" tipo="cmbTiposCertificados"  ancho="170" clase="boxCombo" obligatorio="false" parametro="<%=dato%>" elementoSel="<%=tipoCert%>" />
						</td>
						<td class="labelText">
							<siga:Idioma key="censo.busquedaClientes.literal.nColegiado"/>
						</td>
						<td >
							<html:text name="SolicitudesCertificadosForm" property="numeroCertificado" size="20" maxlength="30" styleClass="box" />
						</td>
						<td class="labelText">
							<siga:Idioma key="censo.busquedaClientes.literal.nif"/>
						</td>
						<td >
							<html:text name="SolicitudesCertificadosForm" property="CIFNIF" size="20" maxlength="30" styleClass="box"/>
						</td>
					</tr>
					<tr>
						...
						<td >
							<html:text name="SolicitudesCertificadosForm" property="nombre" size="20" maxlength="30" styleClass="box"/>
						</td>
						<td class="labelText">
							<siga:Idioma key="censo.busquedaClientes.literal.apellidos"/>
						</td>
						<td >
							<html:text name="SolicitudesCertificadosForm" property="apellido1" size="20" maxlength="30" styleClass="box"/>
						</td>
						<td class="labelText">
							<siga:Idioma key="pys.gestionSolicitudes.literal.idPeticion"/>
						</td>
						<td>
							<html:text name="SolicitudesCertificadosForm" styleClass="box" property="buscarIdSolicitudCertif" maxlength="10" />
						</td>
					</tr>	
					<tr>
						<td class="labelText">
							<siga:Idioma key="certificados.solicitudes.literal.colegioOrigen"/>
						</td>
						<td>
							<siga:ComboBD nombre="idInstitucionOrigen" tipo="cmbInstitucionesAbreviadas"  ancho="160" clase="boxCombo" obligatorio="false" elementoSel="<%=colOrigen%>"/>
						</td>
						<td class="labelText">
							<siga:Idioma key="certificados.solicitudes.literal.colegioDestino"/>
						</td>
						<td>
							<siga:ComboBD nombre="idInstitucionDestino" tipo="cmbInstitucionesAbreviadas" ancho="160" clase="boxCombo" obligatorio="false" elementoSel="<%=colDestino%>"/>
						</td>
						<td class="labelText">
							<siga:Idioma key="pys.gestionSolicitudes.literal.numeroCertificado"/>
						</td>
						<td>
							<html:text name="SolicitudesCertificadosForm" styleClass="box" property="buscarNumCertificadoCompra" maxlength="30" />
						</td>
					</tr>
				</html:form>
			</table>
