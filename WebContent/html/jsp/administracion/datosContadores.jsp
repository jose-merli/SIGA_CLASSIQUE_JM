								...
								<table class="tablaCampos" align="center" border="0">
									...
									<table class="tablaCampos" align="center" border="0">
									 <tr>
										...
										<td class="labelTextValue" colspan="5">																																										
											<% if (modo!=null && modo.equals("editar")){%>
		                                     &nbsp;&nbsp;<siga:Datepicker  nombreCampo="fechaReconfiguracion" valorInicial="<%=fechaReconf%>"/>
											<%}else{%>
												<siga:Datepicker  nombreCampo="fechaReconfiguracion" valorInicial="<%=fechaReconf%>" disabled="true"/>
											<%}%>
