	...
	<body class="tablaCentralCampos">
		<html:form action="/ADM_GestionarUsuarios.do" method="POST" target="submitArea">
			...
			<siga:TablaCabecerasFijas 
		   		  ...
		   		  borde="1"
		   		  clase="tableTitle"
		   		  nombreCol="administracion.usuarios.literal.nombre,administracion.usuarios.literal.NIF,administracion.usuarios.literal.fechaAlta,administracion.usuarios.literal.activo,administracion.certificados.literal.roles,"
		   		  tamanoCol="30,15,8,7,30,10"
		   		  alto="100%"
		   		  modal="M" 
		   		  activarFilaSel="true"
				  ajusteBotonera="true">
