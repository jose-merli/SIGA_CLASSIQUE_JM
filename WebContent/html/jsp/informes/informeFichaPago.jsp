...
<head>
	...
	<siga:Titulo 
		titulo="factSJCS.informes.pago.cabecera" 
...
<body>
	...
	<siga:ConjCampos leyenda="factSJCS.informes.pago.cabecera">		
	...
	<td>
		<siga:ComboBD nombre="idPago" tipo="cmb_PagosTodos" parametro="<%=comboParams%>" clase="boxCombo" obligatorio="false"/>
	</td>
	</tr>
	<tr>
	<td class="labelText">
