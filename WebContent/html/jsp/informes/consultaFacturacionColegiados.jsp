		...
		<fieldset>
			...
			<table class="tablaCampos" align="center">
				<tr>
					...
					<td>
						<siga:ComboBD nombre="idFacturacion" tipo="cmb_CartaFactColegidados" parametro="<%=comboParams%>" clase="boxCombo" obligatorio="true" obligatorioSinTextoSeleccionar="true" ancho="800"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<siga:ComboBD nombre="idFacturacionFinal"	tipo="cmb_CartaFactColegidados" parametro="<%=comboParams%>" clase="boxCombo" obligatorio="false" ancho="800"/>
					</td>
				</tr>
