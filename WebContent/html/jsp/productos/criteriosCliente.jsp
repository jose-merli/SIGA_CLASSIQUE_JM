										...
										<tr>				
											...
											<td class="labelText">
												<% if (modo.equalsIgnoreCase("insertar")){%>
										  			<html:text property="precio" styleClass="boxNumber" maxlength="11" size="10" value=""></html:text>&nbsp;&euro;
										  		<% } else { %>
													<% if (modo.equalsIgnoreCase("modificar")){ %>
														<html:text property="precio" styleClass="boxNumber" size="10" maxlength="11" value="<%=UtilidadesString.mostrarDatoJSP(UtilidadesNumero.formatoCampo(precio))%>"></html:text>&nbsp;&euro;
													<%}else{%>
														<html:text property="precio" styleClass="boxConsulta" size="10" value="<%=UtilidadesString.mostrarDatoJSP(UtilidadesNumero.formatoCampo(precio))%>" readOnly="true"></html:text>&nbsp;&euro;
													<% } %>								  		
										  		<% } %>
											</td>
											<td class="labelText">
										...
										<tr>
											...
											<td>
									  			<iframe src="<%=app%>/html/jsp/productos/criteriosClienteFrame.jsp"
															...
															marginheight="0"
															marginwidth="0";					 
															style="width:480; height:30; z-index:2;left: 0px">
												</iframe>
											</td>
										</tr></table></td></tr>
									  	<%}%>
