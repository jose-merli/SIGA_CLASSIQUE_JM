	...
	<table class="tablaTitulo" cellspacing="0" heigth="32">
		...
		<html:form action="/PYS_GestionarSolicitudes.do" method="POST" target="submitArea" style="display:none">
			...
			<siga:TablaCabecerasFijas 
			   ...
			   borde  = "2"
			   clase  = "tableTitle"
			   nombreCol="pys.gestionSolicitudes.literal.concepto,
			   ...
			   tamanoCol = "10,9,16,5,8,5,9,9,10,7,7"
			   alto="100%"
			   ajuste="120"					   
			>
...
%>
									...
									<siga:FilaConIconos fila='<%=""+(i+1)%>' botones="" clase="listaNonEdit" elementos='<%=elementos%>'
											  							visibleConsulta='no' visibleEdicion='no' visibleBorrado='no' pintarEspacio='no'>

									<!-- Datos ocultos tabla -->
									<td><input type="hidden" id="oculto<%=i+1%>_1" value="<%=productoOServicio%>">
											...
											<%=UtilidadesString.mostrarDatoJSP(concepto)%></td>
									<td>
									...
									<td>
												<input type='text' name='cuenta<%=i+1%>' value="<%=UtilidadesString.mostrarDatoJSP(nCuenta)%>" class=listaNonEdit readOnly=true style="border:none; background-color:transparent" style="width:200">
									</td> 
									<td><%=cantidad%></td> 
									<% if (UtilidadesHash.getDouble (productoServicio, "VALOR")!=null){ %>
