...
<body class="tablaCentralCampos">
		...
		<html:form action="/ENV_RemitentesPlantilla.do" method="POST" target="submitArea" style="display:none">
		...
		<siga:Table 
		   name="tablaDatos"
		   border="1"
		   columnNames="censo.datosDireccion.literal.direccion,
		  ...
		  columnSizes="24,7,7,7,5,7,7,7,16,13">
...
<%	} // del if %>			
		...
		<!-- div style="position:absolute; width:964; height:40; z-index:3; top: 440px; left: 0px" -->				
