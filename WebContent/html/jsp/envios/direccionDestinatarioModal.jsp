<!-- direccionDestinatarioModal.jsp -->
...
<%  
	...
	boolean bEditable = ((String) request.getAttribute("editable")).equals("true");
...
<div id="camposRegistro" class="posicionModalGrande" align="center">
	...
	<siga:ConjCampos leyenda="censo.busquedaClientes.literal.datosCliente">
		...
		<tr align="right">
			<%if (bEditable){%>
			<td align="right">
				<input type="button" class="button" alt="<%=buscar%>" id="idButton"  onclick="return buscar();" value="<%=buscar%>"/>		
