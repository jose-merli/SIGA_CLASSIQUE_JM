...
<div id="camposRegistro" class="posicionModalGrande" align="center">
	...
	<siga:ConjCampos leyenda="censo.busquedaClientes.literal.datosCliente">
		...
		<tr>			
			...
			<td>
				<html:text name="RemitentesForm" property="nombre" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
			...
			<td>
				<html:text name="RemitentesForm" property="apellidos1" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
			...
			<td>
				<html:text name="RemitentesForm" property="apellidos2" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
		</tr>
		...
		<tr>			
			...
			<td colspan="5">
				<html:text name="RemitentesForm" property="descripcion" size="100" maxlength="100" styleClass="<%=estilo%>" readonly="<%=!bEditable%>"></html:text>
			</td>
		</table>
		...
		<tr>			
			...
			<td colspan="5">
				<html:textarea cols="70" rows="2" name="RemitentesForm" property="domicilio" onKeyDown="cuenta(this,100)" onChange="cuenta(this,100)" styleClass="boxConsulta" readOnly="true"></html:textarea>
			</td>
		</tr>
		...
		<tr>			
			...
			<td>
				<html:text name="RemitentesForm" property="provincia" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
			...
			<td>
				<html:text name="RemitentesForm" property="pais" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
		</tr>
		...
		<tr>			
			...
			<td>
				<html:text name="RemitentesForm" property="codigoPostal" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
			...
			<td>
				<html:text name="RemitentesForm" property="fax1" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
			...
			<td>
				<html:text name="RemitentesForm" property="fax2" size="30" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
		</tr>
		...
		<tr>			
			...
			<td colspan="1">
				<html:text name="RemitentesForm" property="movil" size="30" styleClass="boxConsulta" readonly="true" ></html:text>
			</td>
			<td class="labelText">
				<siga:Idioma key="censo.datosDireccion.literal.correo"/>
			</td>
			<td colspan="3">
				<html:text name="RemitentesForm" property="correoElectronico" size="80" styleClass="boxConsulta" readonly="true"></html:text>
			</td>
		</tr>
		<tr>
			<%if (bEditable){%>
			<td align="center">
				<input type="button" class="button" alt="<%=elegirdireccion%>" id="idButton"  onclick="return buscar();" value="<%=elegirdireccion%>"/>		
