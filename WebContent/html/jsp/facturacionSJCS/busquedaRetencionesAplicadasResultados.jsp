...
<!-- BODY -->
	...
	<siga:Table
		name="tablaDatos"
		border="1"
		columnNames="factSJCS.busquedaRetAplicadas.literal.tipoRetencion,factSJCS.busquedaRetAplicadas.literal.letrado
			,factSJCS.busquedaRetAplicadas.literal.destinatarioRetencion,factSJCS.busquedaRetAplicadas.literal.fechaDesde
			,factSJCS.busquedaRetAplicadas.literal.fechaHasta,factSJCS.busquedaRetAplicadas.literal.fechaRetencion
			,factSJCS.busquedaRetAplicadas.literal.importeRetenido,factSJCS.busquedaRetAplicadas.literal.anyomes
			,factSJCS.busquedaRetAplicadas.literal.abonoRelacionado,factSJCS.busquedaRetAplicadas.literal.pagoRelacionado,"
	   columnSizes="8,18,8,7,7,7,9,6,10,16,4">
	...
	<logic:notEmpty name="BusquedaRetencionesAplicadasForm" property="retencionesAplicadas">
		...
		<siga:FilaConIconos 
			...
			<bean:define id="tipoRetencion" name="retencionAplicada" property="tipoRetencion"/>
			...
			<td align="center"><%=UtilidadesString.mostrarDatoJSP(GstDate.getFormatedDateShort(usr.getLanguage(),fechaRetencion))%></td>
			<td align="right"><%=UtilidadesString.mostrarDatoJSP(UtilidadesNumero.formato(importeRetenido.toString()))%> &euro;</td>
			...
			<c:choose>
				...
				<c:otherwise>
					<bean:write name="retencionAplicada" property="abonoRelacionado" />
				</c:otherwise>
			</c:choose>
			</td>
			...
			<c:if test="${retencionAplicada.tipoRetencion=='L'}">
