...
<body  onload="inicio();ajusteAlto('resultado');inicio2();">
	...
	<table align="center" width="100%" border="0">
		...
		<tr>
			...
			<td class="labelText">
				<siga:Datepicker nombreCampo="fechaResolucion"/>

				<siga:Idioma key="gratuita.BusquedaResolucionCAJG.literal.fResolucionHasta"/>
				<siga:Datepicker nombreCampo="fechaResolucionHasta"/>
			</td>
			...
			<td class="labelText">
				<siga:Datepicker nombreCampo="fechaCarga"/>

				<siga:Idioma key="gratuita.BusquedaResolucionCAJG.literal.fCargaHasta"/>
				<siga:Datepicker nombreCampo="fechaCargaHasta"/>
			</td>
