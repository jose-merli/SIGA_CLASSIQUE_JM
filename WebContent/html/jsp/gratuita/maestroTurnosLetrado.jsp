...
<html>
	<head>
		...
		<siga:TituloExt titulo="censo.fichaCliente.sjcs.turnos.datosGenerales.cabecera" localizacion="<%=localiz%>"/>
	</head>
		...
		<siga:ConjCampos leyenda="gratuita.maestroTurnos.literal.datosGenerales">
			<table width="100%" border="0" align="center">
				...
				<tr>
					...
					<td align="left">
						<% if (accion.equalsIgnoreCase("ver")){%>
							<html:text name="DefinirTurnosForm" property="zona" size="50" maxlength="15" styleClass="boxConsulta" value='<%=(String)turno.get("ZONA")%>' readOnly="true" />
					...
					<td align="left">
						<%if (accion.equalsIgnoreCase("ver")){%>
							<html:text name="DefinirTurnosForm" property="subzona" size="15" maxlength="15" styleClass="boxConsulta" value='<%=(String)turno.get("SUBZONA")%>' readOnly="true" />
				...
				<tr>		
					...
					<% if (accion.equalsIgnoreCase("ver")) { %>
						<td colspan="3" class="boxConsulta" align="left">
				...
				<tr>
					...
					<td align="left">
						...
						<% } else { %>
							<html:text name="DefinirTurnosForm" property="partidaPresupuestaria" size="45" maxlength="15" styleClass="boxConsulta" value='<%=(String)turno.get("PARTIDAPRESUPUESTARIA")%>' readOnly="true" />
						<%}%>
					</td>
					...
					<td align="left">
						...
						<% } else { %>
							<html:text name="DefinirTurnosForm" property="grupoFacturacion" size="15" maxlength="15" styleClass="boxConsulta" value='<%=(String)turno.get("GRUPOFACTURACION")%>' readOnly="true" />
						<%}%>		
					</td>
				</tr>	
				...
				<tr>
					...
					<td align="left">
						<textarea class="<%=classTipo%>" name="descripcion"
							...
							<%=valida%>
						><% if (!accion.equalsIgnoreCase("nuevo")){%><%=(String)turno.get("DESCRIPCION")%><%}%></textarea>
					</td>
					...
					<td align="left">
						<textarea class="<%=classTipo%>" name="requisitos"
							onKeyDown="cuenta(this,1023)" onChange="cuenta(this,1023)"  
							style="overflow-y:auto; overflow-x:hidden; width:300px; height:50px; resize:none"
							<%=valida%>
						><% if (!accion.equalsIgnoreCase("nuevo")){%><%=(String)turno.get("REQUISITOS")%><%}%></textarea>
					</td>	
				</tr>	
			</table>	
		</siga:ConjCampos>
			...
			<table border="0" width="100%" align="center">
				<tr>
					...
					<td class="labelText" style="text-align:right">
						...
						%>
							<input type="text" name="crit_1" class="boxConsulta" value="<%=valor1%>" readonly/>&nbsp;<input type="text" name="ord_1" class="boxConsulta" value="<%=orden1%>" readonly/>
						<% } %>
					</td>
					...
					<td class="labelText" style="text-align:right">
						...
						%>
							<input type="text" name="crit_2" class="boxConsulta" value="<%=valor2%>" readonly/>&nbsp;<input type="text" name="ord_2" class="boxConsulta" value="<%=orden2%>" readonly/>
						<% } %>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="labelText" style="text-align:right">
						...
						%>
							<input type="text" name="crit_3" class="boxConsulta" value="<%=valor3%>" readonly/>&nbsp;<input type="text" name="ord_3" class="boxConsulta" value="<%=orden3%>" readonly/>
						<% } %>
					</td>
					...
					<td class="labelText" style="text-align:right">
						...
						%>
							<input type="text" name="crit_4" class="boxConsulta" value="<%=valor4%>" readonly/>&nbsp;<input type="text" name="ord_4" class="boxConsulta" value="<%=orden4%>" readonly/>
						<% } %>
					</td>
				</tr>
			</table>
