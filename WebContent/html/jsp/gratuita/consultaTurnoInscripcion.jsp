					...
					<siga:ConjCampos leyenda="gratuita.maestroTurnos.literal.datosGenerales">
						<table width="100%" border="0">
							...
							<tr>
								...
								<td class="labelText" style="text-align: left;">
									<c:out value="${definirTurnosForm.abreviatura}"></c:out>
								</td>
								<td class="labelText" style="text-align: left;">
									<siga:Idioma key="censo.SolicitudIncorporacion.literal.nombre" />
								</td>
								<td class="labelText" style="text-align: left;">
									<c:out value="${definirTurnosForm.nombre}"></c:out>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="labelText" style="text-align: left">
									<c:out value="${definirTurnosForm.area}"></c:out>
								</td>
								<td class="labelText" style="text-align: left">
									<siga:Idioma key="gratuita.definirTurnosIndex.literal.materia" />
								</td>
								<td class="labelText" style="text-align: left">
									<c:out value="${definirTurnosForm.materia}"></c:out>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="labelText" style="text-align: left">
									<c:out value="${definirTurnosForm.zona}"></c:out>
								</td>
								<td class="labelText" style="text-align: left">
									<siga:Idioma key="gratuita.definirTurnosIndex.literal.subzona" />
								</td>
								<td class="labelText" style="text-align: left">
									<c:out value="${definirTurnosForm.subzona}"></c:out>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3" class="labelText" style="text-align: left">
									<c:out value="${definirTurnosForm.partidoJudicial}"></c:out>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3" class="labelText" style="text-align: left">
									<c:out value="${definirTurnosForm.partidaPresupuestaria}"></c:out>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3" class="labelText" style="text-align: left">
								 	<c:out value="${definirTurnosForm.grupoFacturacion}"></c:out>
								 </td>
							</tr>
							...
							<tr>
								...
								<td wrap class="labelText" style="text-align: left">
									<textarea class="boxConsulta" readonly="readonly"
										style="overflow-y:auto; overflow-x:hidden; width:300px; height:50px; resize:none"
									><c:out value="${definirTurnosForm.descripcion}"></c:out></textarea>
								</td>
								<td class="labelText" style="text-align: left">
								...
								<td class="labelText" style="text-align: left">
									<textarea class="boxConsulta" readonly="readonly"
										style="overflow-y:auto; overflow-x:hidden; width:300px; height:50px; resize:none"
									><c:out value="${definirTurnosForm.requisitos}"></c:out></textarea>
								</td>
							</tr>
						</table>
					</siga:ConjCampos>
								...
								<td class="labelText" style="text-align: center">
									<c:choose>
										...
										<c:when test="${definirTurnosForm.guardias==1}">
											<siga:Idioma key="gratuita.maestroTurnos.literal.guardias.todasNinguna" />
										</c:when>
										
										<c:otherwise>
											<siga:Idioma key="gratuita.maestroTurnos.literal.guardias.elegir" />
										</c:otherwise>
									</c:choose>
								</td>
							</tr>
						...
						<table border="0" width="100%" align="center">
							<tr>
								...
								<td class="labelText" style="text-align:left;width=35%">
									<siga:Idioma key="${definirTurnosForm.crit_1}" />
									&nbsp;<siga:Idioma key="${definirTurnosForm.ord_1}" />
								</td>
								<td class="labelText" style="text-align: left;width=15%">
									<siga:Idioma key="gratuita.maestroTurnos.literal.segundoCriterio" />
								</td>
								<td class="labelText" style="text-align: left;width=35%">
									<siga:Idioma key="${definirTurnosForm.crit_2}" />
									&nbsp;<siga:Idioma key="${definirTurnosForm.ord_2}" />
								</td>
							</tr>
							...
							<tr>
								...
								<td class="labelText" style="text-align: left">
									<siga:Idioma key="${definirTurnosForm.crit_3}" />
									&nbsp;<siga:Idioma key="${definirTurnosForm.ord_3}" />
								</td>
								<td class="labelText" style="text-align: left">
									<siga:Idioma key="gratuita.maestroTurnos.literal.cuartoCriterio" />
								</td>
								<td class="labelText" style="text-align: left">
									<siga:Idioma key="${definirTurnosForm.crit_4}" />
									&nbsp;<siga:Idioma key="${definirTurnosForm.ord_4}" />
								</td>
							</tr>
						</table>
					</siga:ConjCampos>
