					...
					<td>				
						...
						<siga:ConjCampos leyenda="gratuita.retenciones.retencion">
							<table border="0" cellpadding="5" cellspacing="0">
								...
								<tr>
									<td class="boxLabel">
										<input class="boxLabel" type="text" style="width:80px" tabindex="-1" readonly
											value="<siga:Idioma key='gratuita.retenciones.descripcion'/>" />&nbsp;(*)
									</td>
									<td>
										<%if (accion.equalsIgnoreCase("ver")){%>
								...
								<tr>	
									<td class="boxLabel">
										<input class="boxLabel" type="text" style="width:68px" tabindex="-1" readonly
											value="<siga:Idioma key='gratuita.retenciones.retencion'/>" />&nbsp;(*)
									</td>			
									<td>
										<%if (accion.equalsIgnoreCase("ver")){%>
								...
								<tr>
									<td class="boxLabel">
										<input class="boxLabel" type="text" style="width:95px" tabindex="-1" readonly
											value="<siga:Idioma key='gratuita.retenciones.tipoSociedad'/>" />&nbsp;(*)
									</td>			
