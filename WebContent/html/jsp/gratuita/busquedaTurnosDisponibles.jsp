...
<!-- HEAD -->
	...
	<siga:Titulo titulo="gratuita.maestroGuardias.literal.mantenimientoTurnos" localizacion="gratuita.turnos.localizacion"/>
...
<body onLoad="ajusteAlto('resultado');" >
	...
	<table class="tablaTitulo" cellspacing="0" heigth="32">
		<tr>
			...
			<siga:Idioma key="gratuita.listarTurnosDisp.busqueda.titulo"/>
			...
			<td>
				<siga:ConjCampos leyenda="gratuita.mantAsistencias.literal.titulo">
					<table width="100%" border="0" align="center">	
						<html:form action = "/JGR_AltaTurnosGuardias.do" method="POST" target="resultado" enctype="multipart/form-data" onSubmit="return Buscar()">
