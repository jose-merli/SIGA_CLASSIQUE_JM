...
<% 	String app=request.getContextPath();
	...
	String idPersona =  (String)miHash.get(ScsTelefonosPersonaJGBean.C_IDPERSONA);
%>
...
<body>
	...
	<html:form action="/JGR_ContrariosDesignas.do" method="POST" target="submitArea">
