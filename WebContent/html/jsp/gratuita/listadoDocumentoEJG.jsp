...
<body>
	...
	<siga:Table 		   
		name="listadoAreas"
		border="2"
		columnNames="censo.fichaCliente.literal.abreviatura,
	   				gratuita.maestros.documentacionEJG.descripcionTipo,
	   				censo.fichaCliente.literal.abreviatura,
	   				gratuita.maestros.documentacionEJG.descripcionDocu,"
		columnSizes="13,30,15,30,12">	
