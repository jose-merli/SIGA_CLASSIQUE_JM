...
<body>
	...
	<td>
		...
		<%} else {%>
			<siga:Datepicker nombreCampo="fechaLimite" valorInicial="<%=fechaLimite%>"></siga:Datepicker>
		<%}%>
	</td>
	</tr>
	<tr>
	...
	<td>
		...
		<%} else {%>
			<siga:Datepicker nombreCampo="fechaEntrega" valorInicial="<%=fechaEntrega%>"></siga:Datepicker>
		<%}%>
	</td>
		</tr>
