...
<%  
	...
	formador = new java.text.SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	String fechaValor 	= formador.format(new Date());
...
<div id="camposRegistro" class="posicionModalGrande" align="center">
	...
	<html:form action="JGR_InscribirseEnGuardia.do" method="post" target="_self">
	 ...
	 <table width="100%" border="0">
		...
		<!-- obtenemos los campos para el alta de turnos -->
			...
			<td width="20%" class="labelText">
				<siga:Idioma key="gratuita.altaGuardia.literal.fechaSuscripcion"/>&nbsp;
			</td>
			<td width="75%">				
				<html:text name="DefinirGuardiasTurnosForm" property="fechaInscripcion" size="10" maxlength="10" styleClass="boxConsulta" value="<%=fecha%>" readOnly="true" ></html:text>
<!--				&nbsp;<input type="checkbox" name="suscripcion" value="no" checked disabled> -->
		...
		<tr>
			...
			<html:textarea name="DefinirGuardiasTurnosForm" onKeyDown="cuenta(this,1024)" onChange="cuenta(this,1024)" property="observacionesInscripcion" cols="140" rows="2" style="overflow:auto" styleClass="boxCombo" value="<%=observaciones%>" readOnly="false" ></html:textarea>
		</tr>
	</table>
   </siga:ConjCampos>
   </td>
   ...
   <%
	...
	%>
		<div style="position:absolute;top:420px;left: 0px">
			<p class="labelText" style="text-align:center">
				<siga:Idioma key="gratuita.altaGuardia.literal.infElegir"/>
			</p>
		</div>
	...
	%>
			...
			<siga:ConjBotonesAccion botones="c,s" clase="botonesDetalle" />	
...
//			document.forms[0].fechaInscripcion.value="<%=fechaValor%>";
