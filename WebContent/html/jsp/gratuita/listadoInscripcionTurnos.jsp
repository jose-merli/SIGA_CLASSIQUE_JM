...
<body>
	<table id='tabInscripcionesCabeceras' border='1' width='100%' cellspacing='0' cellpadding='0'>
		<tr class='tableTitle'>
			...
			<td align='center' width='8%'>
				<siga:Idioma key="gratuita.gestionInscripciones.fecha.solicitud.alta"/>
			</td>
			<td align='center' width='8%'>
				<siga:Idioma key="gratuita.gestionInscripciones.fecha.estado.alta"/>
			</td>
			<td align='center' width='8%'>
				<siga:Idioma key="gratuita.gestionInscripciones.solicitud.baja"/>
			</td>
			<td align='center' width='8%'>
				<siga:Idioma key="gratuita.gestionInscripciones.estado.baja"/>
			</td>
	...
	<div id='divInscripcionesDatos' style='position:absolute; width:100%; overflow-y:auto'>		
