...
<tr>
	...
	<!-- SUBCONJUNTO DE DATOS -->
		...
		<tr>
			...
			<td>
				<html:text name="SaltosYCompensacionesForm" property="fechaCumplimiento" size="10" styleClass="<%=estilo %>" value="<%=fechaCumplimiento%>" readOnly="true"></html:text>
				&nbsp;
				<% if(modo.equalsIgnoreCase("EDITAR")) { %>
					<a onClick="return showCalendarGeneral(fechaCumplimiento);" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('Calendario','','<%=app%>/html/imagenes/calendar_hi.gif',1);"><img src="<%=app%>/html/imagenes/calendar.gif" alt='<siga:Idioma key="general.literal.seleccionarFecha"/>'  border="0"></a>
				<% } %>
			</td>
		</tr>		
		<tr>
