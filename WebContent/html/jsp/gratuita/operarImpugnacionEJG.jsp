...
<body>
	...
	<!-- FILA -->
		<tr>
			...
			<td class="labelText">
				<%if (accion.equalsIgnoreCase("ver")) {%>
					<siga:Datepicker nombreCampo="fechaAuto" valorInicial="<%=fechaAuto%>" disabled="true" readonly="true"></siga:Datepicker>
				<%}else{%>
					<siga:Datepicker nombreCampo="fechaAuto" valorInicial="<%=fechaAuto%>" readonly="true"></siga:Datepicker>
				<%}%>
			</td>
			<td class="labelText">
		...
		<tr>
			...
			<td class="labelText">			
				<%if (accion.equalsIgnoreCase("ver")) {%>
					<siga:Datepicker nombreCampo="fechaPublicacion" valorInicial="<%=fechaPublicacion%>" disabled="true" readonly="true"></siga:Datepicker>
					
				<%}else{%>
					<siga:Datepicker nombreCampo="fechaPublicacion" valorInicial="<%=fechaPublicacion%>" readonly="true"></siga:Datepicker>
