...
<body>
	...
	<tr>
		<td id="titulo" class="titulitosDatos">
				<siga:Idioma key="gratuita.consultaTurnoMasivo.literal.title1"/>
		</td>
	</tr>
	</table>
...
-->
	...
	<input type="hidden" name="origen" value="altaTurnosMasivo">
	...
	<script language="JavaScript">
		...
		{	sub();
			...
			{  
				...
				document.forms[0].validarInscripciones.value="S";
			}else{
			    document.forms[0].validarInscripciones.value="N";
			}
