			 ...
			 var ele = document.getElementsByName('altaTurno');
			   ...
			   var datos='';
				for (i = 0; i < ele.length; i++) {
				    if(ele[i].checked){
					  ...
					  var datos = datos +","+ document.getElementById (idTurno).value+"##"+document.getElementById (validar).value ; 
						if (document.getElementById (validar).value=='S'){
					  		document.forms[0].validarTurno.value=document.getElementById (validar).value;
						}
				...
				if (mostrarMensaje) {
				   ...
				   document.forms[0].turnosSel.value=datos;
				  
					document.forms[0].paso.value="turnoMasivo";
...
<body>
	...
	<tr>
		<td id="titulo" class="titulitosDatos">
				<siga:Idioma key="gratuita.listarTurnosDisp.literal.title"/>
		</td>
	</tr>    
	</table>
