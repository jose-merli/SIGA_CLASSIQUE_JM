...
<body class="tablaCentralCampos">	
	...
	<td width="100%" align="center">
		...
		<siga:TablaCabecerasFijas 		   
		   ...
		   borde="1"
		   clase="tableTitle"		   
		   nombreCol="gratuita.operarEJG.literal.fechaLimitePresentacion,sjcs.ejg.documentacion.presentador,expedientes.auditoria.literal.documento,gratuita.documentacionEJG.regentrada,gratuita.documentacionEJG.regsalida,gratuita.operarEJG.literal.fechaPresentacion,"
		   tamanoCol="10,25,25,10,10,10"
		   			alto="100%"
		   			ajusteBotonera="true"		
