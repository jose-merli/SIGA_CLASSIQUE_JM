...
<div id="camposRegistro" class="posicionModalGrande" align="center">
	...
	<html:form action="JGR_ContrariosAsistencia.do" method="POST" target="mainPestanas">
...
<!-- FIN: SUBMIT AREA -->	
	...
	<script language="JavaScript">
		...
		function accionGuardar() {				
			...
			if(validateAsistencias1Form(document.contrariosAsistenciaForm)) {
