...
<script
	...
	type="text/javascript"></script>
	<script
	src="<html:rewrite page='/html/js/validacionStruts.js'/>"
	type="text/javascript"></script>
...
<body>
	...
	<td id="titulo" class="titulitosDatos">
		<c:if test="${InscripcionTGForm.modo=='sitInsertar'}">
			<siga:Idioma key="gratuita.gestionInscripciones.paso.inscripcion.turno.contacto"/>
		</c:if>
		<c:if test="${InscripcionTGForm.modo=='smitInsertar'}">
			<siga:Idioma key="gratuita.gestionInscripciones.paso.inscripcion.turno.masiva.contacto"/>
		</c:if>
		...
		<table class="tablaCentralCamposGrande" align="center" border="0" >
			<tr>				
				<td>
						...
						<tr>
		   					<td class="labelText"><siga:Idioma key="censo.datosDireccion.literal.telefono1"/>&nbsp;(*)</td>				
		   					<td><html:text name="InscripcionTGForm" property="telefono1"  maxlength="20" size="10" styleClass="box"></html:text></td>

		   					<td class="labelText"><siga:Idioma key="censo.datosDireccion.literal.telefono2"/>&nbsp;</td>				
		   					<td><html:text name="InscripcionTGForm" property="telefono2"  maxlength="20" size="10" styleClass="box"></html:text></td>	
		 					</tr>

		 					<tr>
		   					<td class="labelText"><siga:Idioma key="censo.datosDireccion.literal.movil"/>&nbsp;</td>				
		   					<td><html:text name="InscripcionTGForm" property="movil"  maxlength="20" size="10" styleClass="box"></html:text></td>	
		 					</tr>

		 					<tr>
		   					<td class="labelText"><siga:Idioma key="censo.datosDireccion.literal.fax1"/>&nbsp;</td>
		   					<td><html:text name="InscripcionTGForm" property="fax1"  maxlength="20" size="10" styleClass="box"></html:text></td>
		  				 	
		  				 	<td class="labelText"><siga:Idioma key="censo.datosDireccion.literal.fax2"/>&nbsp;</td>				
		   					<td><html:text name="InscripcionTGForm" property="fax2"  maxlength="20" size="10" styleClass="box"></html:text></td>
		  				</tr>
		   			</table>
