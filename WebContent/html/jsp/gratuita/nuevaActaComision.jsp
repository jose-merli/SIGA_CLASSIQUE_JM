	...
	<html:form action="/JGR_ActasComisionEd" method="POST" target="submitArea">
		...
		<siga:ConjCampos leyenda="general.criterios">	
			...
			<tr>
				...
				<td>
					<siga:Datepicker nombreCampo="fechaResolucion" valorInicial="${ActaComisionForm.fechaResolucion}"/> 
			...
			<tr>
				...
				<td>
					<siga:Datepicker nombreCampo="fechaReunion" valorInicial="${ActaComisionForm.fechaReunion}"/> 
