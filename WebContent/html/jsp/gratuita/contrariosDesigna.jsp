...
<body class="tablaCentralCampos">
	...
	<html:form action="/JGR_ContrariosDesignas.do" method="post" target="mainPestanas" style="display:none">
		<html:hidden property = "modo" value = ""/>
		<html:hidden property = "actionModal" value = ""/>
	</html:form>
		
	<iframe align="center" src="<html:rewrite page='/html/jsp/gratuita/listarContrariosDesignas.jsp'/>"
		id="resultado"
		name="resultado" 
		scrolling="no"
		frameborder="0"
