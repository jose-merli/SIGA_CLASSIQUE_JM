...
%>
					...
					<td id="cuentaBancaria">						
						<html:select styleId="cuentasSJCSSociedad" styleClass="boxCombo" property="idCuenta">
							<bean:define id="cuentasSJCSSociedad" name="RetencionesIRPFForm" property="cuentasSJCSSociedad" type="java.util.Collection" />
...
%>
							...
							<%=GstDate.getFormatedDateShort(usr.getLanguage(), ((String) hash.get("FECHAINICIO")))%>&nbsp;
						</td>
						<td><%=GstDate.getFormatedDateShort(usr.getLanguage(), ((String) hash.get("FECHAFIN")))%>&nbsp;</td>
<%
					} else {
						// Si la fecha de inicio no es null indica que aunque sea sociedad hay algun registro en la tabla scs_retencionesirpf que guarda el irpf si el cliente actua como letrado
