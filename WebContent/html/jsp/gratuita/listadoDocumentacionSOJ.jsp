...
<body class="tablaCentralCampos">	
	...
	<html:form action="/JGR_PestanaSOJDocumentacion" method="post" target="mainPestanas" style="display:none">
		...
		<siga:TablaCabecerasFijas 		   
		   ...
		   borde="2"
		   clase="tableTitle"		   
		   nombreCol="gratuita.operarEJG.literal.fechaLimitePresentacion,pestana.justiciagratuitaejg.documentacion,gratuita.documentacionSOJ.regentrada,gratuita.documentacionSOJ.regsalida,gratuita.operarEJG.literal.fechaPresentacion,"
		   tamanoCol="10,50,10,10,10"
		   			alto="100%"
		   			ajusteBotonera="true"		
