							...
							<td colspan ="4">
								...
								<table>
									...
									<tr>
										...
										<td>
											<siga:Datepicker nombreCampo="fechaJustificacionDesde"  readOnly="true"></siga:Datepicker>
										</td>
										<td class="labelText">
											<siga:Idioma key="general.literal.hasta"/>
										</td>
										<td>
											<siga:Datepicker nombreCampo="fechaJustificacionHasta"  readOnly="true"></siga:Datepicker>
										</td>
										<td class="labelText" >
					...
					<siga:ConjCampos  leyenda="gratuita.busquedaDesignas.literal.datosDesigna">
						<table>
							...
							<tr>
								...
								<td>
									<siga:Datepicker nombreCampo="fechaDesde"  readOnly="true"></siga:Datepicker>
								</td>
								<td class="labelText">
									<siga:Idioma key="general.literal.hasta"/>
								</td>
								<td>
									<siga:Datepicker nombreCampo="fechaHasta"  readOnly="true"></siga:Datepicker>								
								</td>
								<td class="labelText">
