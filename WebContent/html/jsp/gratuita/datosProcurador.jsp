						...
						<table class="tablaCampos" border="0" width="100%">	
						  <tr>
							...
							<tr>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="nombre" size="30" maxlength="200" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="apellido2" size="30" maxlength="100" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<siga:ComboBD nombre="idColProcurador" tipo="comboColegioProcuradores" clase="<%=estiloCombo%>" obligatorio="true" elementoSel="<%=colegioSel%>" readonly="<%=comboLectura%>"/>						
								</td>						
							</tr>
							...
							<tr>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="NColegiado" size="30" maxlength="100" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<html:text name="MantenimientoProcuradorForm" property="direccion" size="50" maxlength="100" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<% if (modo.equalsIgnoreCase("VER")) { %>
											<html:text name="MantenimientoProcuradorForm" property="provincia" styleClass="boxConsulta" size="20" readonly="<%=desactivado%>" />
									<% } else { %>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="codigoPostal" size="5" maxlength="5" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<% if (modo.equalsIgnoreCase("VER")) { %>
											<html:text name="MantenimientoProcuradorForm" property="poblacion" styleClass="boxConsulta" size="30" readonly="<%=desactivado%>" />
									<% } else { %>
										<% if (modo.equalsIgnoreCase("NUEVO")) { %>
							...
							<tr>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="telefono1" size="30" maxlength="20" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="fax1" size="30" maxlength="20" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="telefono2" size="30" maxlength="20" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
								...
								<td>
									<html:text name="MantenimientoProcuradorForm" property="email" size="30" maxlength="100" styleClass="<%=estilo%>" readonly="<%=desactivado%>" />
								</td>
							</tr>
						</table>
					</siga:ConjCampos>	
