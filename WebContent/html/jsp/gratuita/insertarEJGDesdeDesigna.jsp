	...
	<siga:ConjCampos leyenda="gratuita.busquedaEJG.literal.expedientesEJG">
		...
		-->	
			...
			<tr>
				...
				<td class="labelText">		
					<siga:Datepicker nombreCampo="fechaApertura" valorInicial="<%=fecha%>" readOnly="true" posicionX="10"  posicionY="10" postFunction="actualizarFecha();rellenarComboGuardia();"></siga:Datepicker>
				</td>
			<!--	
				<td class="labelText" colspan="2">
