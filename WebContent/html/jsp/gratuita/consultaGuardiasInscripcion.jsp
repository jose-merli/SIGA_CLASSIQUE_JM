...
<body onload="activarDesactivarCheck();">
	...
	<html:form action="${path}" method="POST"	target="_top">
		...
		<siga:Table 
			name="altaTurno" 
			border="1"
			columnNames="<input type='checkbox' id='chkGeneral' name='chkGeneral' onclick='marcarDesmarcarTodos(this);'/>,
				gratuita.altaTurnos_2.literal.nombre,
				gratuita.altaTurnos_2.literal.nletrados,
				gratuita.altaTurnos_2.literal.tipodias,
				gratuita.altaTurnos_2.literal.diasguardia,"
			...
			<logic:notEmpty name="InscripcionTGForm" property="inscripcionesGuardia">
				<logic:iterate name="InscripcionTGForm" property="inscripcionesGuardia" id="inscripcionGuardia" indexId="index">
					...
					<siga:FilaConIconos fila='<%=String.valueOf(index.intValue())%>' botones=""  clase="listaNonEdit" pintarEspacio="false">
						<td align="center">
						...
						<td><c:out value="${inscripcionGuardia.guardia.nombre}"></c:out></td>
						<td align="center"><c:out value="${inscripcionGuardia.guardia.numeroLetradosGuardia}"></c:out></td>
						<td align="center"><c:out value="${inscripcionGuardia.guardia.seleccionTiposDia}"></c:out></td>
						<td align="center">
							<c:out value="${inscripcionGuardia.guardia.diasGuardia}"></c:out>
							&nbsp;
							<siga:Idioma key="${inscripcionGuardia.guardia.descripcionTipoDiasGuardia}" />							
						</td>
					</siga:FilaConIconos>
				</logic:iterate>
			</logic:notEmpty>
