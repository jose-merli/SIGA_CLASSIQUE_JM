	...
	<body>
		...
		<table class="tablaTitulo" cellspacing="0" heigth="32">
			<tr>
				<td id="titulo" class="titulitosDatos">
					<siga:Idioma key="informes.cartaEJG.cabecera"/>
				</td>
			</tr>
		</table>
		...
		<div id="camposRegistro" class="posicionModalMedia" align="center">
			...
			<table  class="tablaCentralCamposMedia"  align="center">
				...
				<html:form action="/JGR_EJG" method="POST" >
			...
			{					
				...
				submitArea.location='/SIGA/html/jsp/general/loadingWindowOpener.jsp?formName='+f.name+'&msg=messages.wait';
			}
