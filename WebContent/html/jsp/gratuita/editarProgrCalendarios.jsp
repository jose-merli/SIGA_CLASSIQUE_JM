		...
		<tr>
			<c:choose>
				...
				<c:otherwise>
					...
					<td><siga:Fecha nombreCampo="fechaProgramacion" valorInicial="${ProgrCalendariosFormEdicion.fechaProgramacion}" readOnly="true" disabled="true"/>
		...
		<tr>
			...
			<c:choose>
				<c:when test="${ProgrCalendariosFormEdicion.modo!='consultarProgrCalendarios'}">
					...
					<td>
						<siga:Fecha nombreCampo="fechaCalInicio" valorInicial="${ProgrCalendariosFormEdicion.fechaCalInicio}"/>
					</td>
					<td class="labelText"><siga:Idioma key='general.literal.hasta'/></td>
					<td>
						<siga:Fecha nombreCampo="fechaCalFin" valorInicial="${ProgrCalendariosFormEdicion.fechaCalFin}"/>
					</td>
