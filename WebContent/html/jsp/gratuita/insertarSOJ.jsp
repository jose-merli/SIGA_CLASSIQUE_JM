...
<body>
	...
	<tr>
		...
		<td class="labelText">		
			<siga:Fecha nombreCampo="fechaAperturaSOJ" valorInicial="<%=fechaHoy%>" postFunction="actualizarFecha();parent.rellenarComboGuardia();"></siga:Fecha>
		</td>
	</tr>	
		...
		<table class="tablaCampos" align="center" border="0" >
			<tr>
				...
				<td class="labelText" colspan="4">
					<siga:ComboBD nombre = "identificador" tipo="turnosSOJSinBaja"  clase="boxCombo" obligatorio="false" accion="Hijo:idGuardia;" parametro="<%=dato%>" ancho="550"/>
				</td>
			</tr>
			<tr>
				<td class="labelText">	
