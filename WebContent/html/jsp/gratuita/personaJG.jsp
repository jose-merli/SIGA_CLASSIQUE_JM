	...
	<tr>
		...
		%>
			<%
				if (!accion.equalsIgnoreCase("ver")) {
			%>
			 <siga:Datepicker  nombreCampo= "fechaNac" valorInicial="<%=fechaNac%>" postFunction="proFechaNac();" />
			<%
				}else{
			%>
			 <siga:Datepicker  nombreCampo= "fechaNac"  valorInicial="<%=fechaNac%>" disabled="true"/>
			 <%
				}
			%>
		</td>
