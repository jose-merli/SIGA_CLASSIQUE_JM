...
<body onLoad="ajusteAlto('resultado');buscar();">
	...
	<html:form action = "/JGR_DesignasRealizadas.do" method="POST" target="resultado">
				...
				<td>
					<siga:ConjCampos>
						<table>
							<tr>
								<td class="labelText">
									<siga:Idioma key="gratuita.listarDesignasTurno.literal.anio"/>
								</td>
								<td>
	...
	<script language="JavaScript">
		...
		function buscar ()
		{
			<!-- valida el año, que sea un valor numérico o vacío -->
			document.getElementById("anio").value = trim(document.getElementById("anio").value);
			if (!isAllDigits(document.getElementById("anio").value) &&
			...
			sub();
			document.BusquedaDesignasForm.modo.value = "buscarInit";
			document.BusquedaDesignasForm.submit();
		}
