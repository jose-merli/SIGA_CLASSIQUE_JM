...
<html>
	...
	<body>
		...
		<table  class="tablaCentralCamposPeque"  align="center">
			...
			<html:form action="/FAC_TiposServicios.do" method="POST" focus="idTipoServicios" target="submitArea">
				...
				<tr>				
					<td>
						...
						<siga:ConjCampos leyenda="facturacion.nuevoTipoServicio.literal.leyenda">
							<table class="tablaCampos" align="center">
								...
								<td>
									<siga:ComboBD nombre="idTipoServicios" tipo="cmbTipoServicio_2" clase="boxCombo" parametro="<%=dato%>" ancho="300"/>
								</td>
								</tr>		
							</table>
						</siga:ConjCampos>
		...
		<script language="JavaScript">
			...
			{
				sub();
				if (validateTiposServiciosForm(document.TiposServiciosForm)){	
