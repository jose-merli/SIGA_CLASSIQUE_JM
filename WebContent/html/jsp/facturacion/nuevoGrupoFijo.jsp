...
<html>
	...
	<body>
		...
		<table class="tablaTitulo" cellspacing="0" heigth="32">
			<tr>
				<td id="titulo" class="titulitosDatos">
					<siga:Idioma key="facturacion.nuevoGrupoFijo.literal.titulo"/>
				</td>
			</tr>
		</table>
		...
		<table  class="tablaCentralCamposPeque"  align="center">
			...
			<html:form action="/FAC_GruposFijos.do" method="POST" focus="idGrupo" target="submitArea">
				...
				<tr>				
					<td>
						...
						<siga:ConjCampos leyenda="facturacion.nuevoGrupoFijo.literal.leyenda">
							<table class="tablaCampos" align="center">
								...
								dato[1] = idSerieFacturacion;
								dato[2] = idInstitucion;
								%>
				
								<tr colspan="100%" align="center"> 
									<td class="labelText">
									<siga:Idioma key="facturacion.nuevoGrupoFijo.literal.leyenda"/>&nbsp;(*)
									</td>
									<td>
									<siga:ComboBD nombre="idGrupo" tipo="cmbGruposCliente" clase="boxCombo" parametro="<%=dato%>" ancho="300"/>
									</td>
		...
		<script language="JavaScript">
			...
			{
				sub();
				if (validateGruposFijosForm(document.GruposFijosForm)){	
