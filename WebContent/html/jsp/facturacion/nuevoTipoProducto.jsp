...
<html>
	...
	<body>
		...
		<table class="tablaTitulo" cellspacing="0" heigth="32">
			<tr>
				<td id="titulo" class="titulitosDatos">
					<siga:Idioma key="facturacion.nuevoTipoProducto.literal.titulo"/>
				</td>
			</tr>
		</table>
		...
		<table  class="tablaCentralCamposPeque"  align="center">
			...
			<html:form action="/FAC_TiposProductos.do" method="POST" focus="idTipoProducto" target="submitArea">
				...
				<tr>				
					<td>
						...
						<siga:ConjCampos leyenda="facturacion.nuevoTipoProducto.literal.leyenda">
							<table class="tablaCampos" align="center">
								...
								<tr colspan="100%" align="center"> 
									<td class="labelText"><siga:Idioma key="facturacion.nuevoTipoProducto.literal.leyenda"/>&nbsp;(*)
									</td>
									<td>
									<siga:ComboBD nombre="idTipoProducto" tipo="cmbTipoProducto_2" clase="boxCombo" parametro="<%=dato%>" ancho="300"/>
									</td>
								</tr>			
							</table>
						</siga:ConjCampos>
		...
		<script language="JavaScript">
			...
			{
				sub();
				if (validateTiposProductosForm(document.TiposProductosForm)){
