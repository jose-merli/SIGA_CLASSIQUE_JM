					...
					<table class="tablaCampos" align="center">
						<html:form action="/FAC_AbonosLineas.do" method="POST" target="submitArea">
							...
							<tr>
								...
								<td class="labelTextValue">
									<% if (nextModo.equalsIgnoreCase("insertar")){ %>
										<html:text property="cantidad" size="13" maxlength="10" styleClass="<%=estiloBoxNumber%>" readonly="<%=breadonly%>"  
											value="" onchange="calcularNeto();" />
									<% } else { %>
										<html:text property="cantidad" size="13" maxlength="10" styleClass="<%=estiloBoxNumber%>" readonly="<%=breadonly%>"  
											value="<%=registro.getString(FacLineaAbonoBean.C_CANTIDAD)%>" onchange="calcularNeto();" />
						  	    	<% } %>
								</td>
							</tr>
