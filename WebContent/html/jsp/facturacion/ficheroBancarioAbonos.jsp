		...
		<html:form action="/FAC_EnvioAbonosABanco.do" method="POST" target="submitArea" style="display:none">		
			...
			<%} %>
				...
				<siga:TablaCabecerasFijas 
		   			...
		   			estilo=""
				   	clase="tableTitle"
				  	nombreCol="facturacion.ficheroBancarioAbonos.literal.fecha,facturacion.ficheroBancarioAbonos.literal.banco,facturacion.ficheroBancarioAbonos.literal.nAbonos,facturacion.ficheroBancarioPagos.literal.importeTotalRemesa,"
				  	tamanoCol="10,50,15,15,10"
		   			alto="100%"
		   			ajusteBotonera="true"		
				    modal="M"> 		  
