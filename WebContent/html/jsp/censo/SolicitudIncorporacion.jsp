...
<head>
	...
	<script type="text/javascript" src="<html:rewrite page='/html/js/SIGA.js'/>"></script>	<script type="text/javascript" src="<html:rewrite page='/html/js/validation.js'/>"></script>
					...
					<td style="padding:0px">
						<table border="0" cellpadding="5" cellspacing="0">
							<tr>
								...
								<td>
									<siga:Datepicker nombreCampo="fechaEstadoColegial" valorInicial=""/>
								</td>
							</tr>
						</table>
					</td>
					...
					<td colspan="7" style="padding:0px">
						<table border="0" cellpadding="5" cellspacing="0">
							<tr>			
								...
								<td>
									<siga:Datepicker nombreCampo="fechaNacimiento" valorInicial=""/>
								</td>		
