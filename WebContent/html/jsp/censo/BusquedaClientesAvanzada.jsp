						...
						<siga:ConjCampos leyenda="censo.busquedaClientesAvanzada.literal.titulo1">
							<table class="tablaCampos" align="center" border="0">
								...
								<tr>				
									...
									<td>
										<siga:Datepicker nombreCampo= "fechaNacimientoDesde" valorInicial="<%=fechaNacimientoDesde%>"/>										
									</td>
									...
									<td>
										<siga:Datepicker  nombreCampo= "fechaNacimientoHasta" valorInicial="<%=fechaNacimientoHasta%>"/>										
									</td>
								</tr>
								...
								<table class="tablaCampos" align="center" width="100%" border="0">
									...
									<% if (colegiado.equals(ClsConstants.DB_TRUE) || colegiado.equals("2")){ %>
										...
										<tr>				
											...
											<td>
												<siga:Datepicker nombreCampo= "fechaIncorporacionDesde" valorInicial="<%=fechaIncorporacionDesde%>"/>
											</td>
											...
											<td>
												<siga:Datepicker nombreCampo= "fechaIncorporacionHasta" valorInicial="<%=fechaIncorporacionHasta%>"/>
											</td>
										</tr>
						...
						<siga:ConjCampos leyenda="censo.busquedaClientesAvanzada.literal.titulo3">
							<table class="tablaCampos" align="center">
								...
								<tr>				
									...
									<td>
										<siga:Datepicker nombreCampo= "fechaAltaDesde" valorInicial="<%=fechaAltaDesde%>"/>
									</td>
									...
									<td>
										<siga:Datepicker nombreCampo= "fechaAltaHasta" valorInicial="<%=fechaAltaHasta%>"/>
									</td>
								</tr>
							</table>
						</siga:ConjCampos>
