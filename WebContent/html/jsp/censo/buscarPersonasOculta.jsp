...
<% 
	...
	if (resultado!=null && (resultado.size()>0)){
		Hashtable h =(Hashtable)resultado.get(0);

		numero=(String)h.get("IDPERSONA");
		nombre=(String)h.get("NOMBRE")+" "+(String)h.get("APELLIDOS1")+" "+(String)h.get("APELLIDOS2");
