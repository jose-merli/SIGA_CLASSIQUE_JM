				...
				<td>
					<siga:ConjCampos leyenda="censo.consultaDatosBancarios.cabecera">
						...
						<% } %>  					
							...
							<!-- FILA -->
							<tr>						
								<td class="labelText"><html:text size="4"  maxlength="4" name="cuentasBancariasForm" property="cbo_Codigo"     value="<%=cbo_Codigo%>" 				styleClass="<%=clase%>" readOnly="<%=desactivado%>" onChange="document.all.cuentasBancariasForm.banco.value=document.all.cuentasBancariasForm.cbo_Codigo.value"></html:text></td>
