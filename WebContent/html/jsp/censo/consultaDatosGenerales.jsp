	...
	<tr>
		<td>
				...
				<tr>
					...
					<td>
					<% if (!breadonly && bDatosGeneralesEditables) { %>
					<siga:Datepicker  nombreCampo= "fechaNacimiento" valorInicial="<%=fechaNacimiento %>"/>
					<% } else { %>
					<siga:Datepicker  nombreCampo= "fechaNacimiento" valorInicial="<%=fechaNacimiento %>" disabled="true"/>
					<% } %>
					</td>
