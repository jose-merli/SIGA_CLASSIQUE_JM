...
<%
	...
	//Vector resultado = (Vector) request.getAttribute("paginador");
	...
	String action=app+"/CEN_FacturasCliente.do?noReset=true&bIncluirRegistrosConBajaLogica="+(String)request.getSession().getAttribute("bIncluirRegistrosConBajaLogica") + 
	              "&idInstitucion="+SidInstitucion.toString()+"&idPersona="+SidPersona.toString()+"&nombre="+nombre+"&numero="+numero+"&accion="+accion;
