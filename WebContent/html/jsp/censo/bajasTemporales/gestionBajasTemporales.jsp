	...
	<html:form action="${path}"  method="POST" target="mainWorkArea">
		...
		<siga:ConjCampos leyenda="censo.bajastemporales.leyenda.busqueda">
			<table width="100%" border="0">
				...
				<tr>
					<td class="labelText">
						<siga:Idioma key="censo.bajastemporales.situacion" />
					</td>
					<td  align="left">
						...
						<html:select styleId="situacion" property="situacion" onclick="accionComboSituacion();" styleClass="boxCombo" >					
							<html:option value="T"><siga:Idioma key="censo.bajastemporales.situacion.todos" /></html:option>
							<html:option value="B"><siga:Idioma key="censo.bajastemporales.situacion.bajaTemporal" /></html:option>
							<html:option value="A"><siga:Idioma key="censo.bajastemporales.situacion.activos" /></html:option>					
						</html:select>	
					</td>				
				
					<td class="labelText">
						<siga:Idioma key="censo.bajastemporales.estadoBaja" />
					</td>
					<td align="left">
						<html:select styleId="estadoBaja" property="estadoBaja"   styleClass="boxCombo" >
							...
							<html:option value="P"><siga:Idioma key="censo.bajastemporales.estadoBaja.pendiente" /></html:option>
							<html:option value="V"><siga:Idioma key="censo.bajastemporales.estadoBaja.aceptado" /></html:option>
							<html:option value="D"><siga:Idioma key="censo.bajastemporales.estadoBaja.denegado" /></html:option>
						</html:select>
					</td>
				</tr>
				...
				<tr>
					<td class="labelText"> 
						<siga:Idioma key="censo.bajastemporales.turno" />
					</td>
					<td>
						<html:select styleId="turnos" styleClass="boxCombo" style="width:320px;" property="idTurno" >
							<bean:define id="turnos" name="BajasTemporalesForm" property="turnos" type="java.util.Collection" />
							<html:optionsCollection name="turnos" value="idTurno" label="nombre" />
						</html:select>
					</td>
					
					<td class="labelText">
						<siga:Idioma key="censo.bajastemporales.guardia" />
					</td>
					<td>
						<html:select styleId="guardias" styleClass="boxCombo" style="width:320px;" property="idGuardia" >
							<bean:define id="guardias" name="BajasTemporalesForm" property="guardias" type="java.util.Collection" />
						...
						<table align="left">
							<tr>		
								<td class="labelText" width="60px">
									<siga:Idioma key="censo.bajastemporales.tipo"/>
								</td>
								<td width="200px">
								...
								<td class="labelText" width="110px">
									<siga:Idioma key="censo.bajastemporales.filtro.fechaDesde"/>&nbsp;(*)
								</td>
								<td width="120px">
								...
								<td class="labelText" width="50px">
									<siga:Idioma key="censo.bajastemporales.filtro.fechaHasta"/>
								</td>
								<td width="120px">
