		...
		<table width="100%" border="0">
			...
			<tr>
				...
				<c:choose>
					...
					<c:otherwise>
						<td class="labelText"><c:out value="${BajasTemporalesForm.colegiadoNumero}"></c:out></td>
						<td colspan="2" class="labelText"><c:out value="${BajasTemporalesForm.colegiadoNombre}"></c:out></td>
					</c:otherwise>
				</c:choose>
			</tr>
			...
			<tr>
				<c:choose>
					<c:when test="${BajasTemporalesForm.modo=='insertarNuevaSolicitud'}">
						...
						<td><siga:Fecha  nombreCampo= "fechaDesde" posicionX="10" posicionY="10"/></td>
						
						<td class="labelText"><siga:Idioma key="censo.bajastemporales.fechaFin"/></td>
						<td><siga:Fecha  nombreCampo= "fechaHasta"  posicionX="10" posicionY="10"/></td>		
					</c:when>
					
					<c:otherwise>
						<td class="labelText" style="align:left"><siga:Idioma key="censo.bajastemporales.fechaInicio"/></td>
						<td><siga:Fecha  nombreCampo= "fechaDesde" posicionX="10" posicionY="10" valorInicial="${BajasTemporalesForm.fechaDesde}"/></td>
						
						<td class="labelText"><siga:Idioma key="censo.bajastemporales.fechaFin"/></td>
						<td><siga:Fecha  nombreCampo= "fechaHasta"  posicionX="10" posicionY="10" valorInicial="${BajasTemporalesForm.fechaHasta}"/></td>
					</c:otherwise>
				</c:choose>
			</tr>
			...
			<tr>
				...
				<td align="left" colspan="3">			
					<html:textarea name="BajasTemporalesForm" property="descripcion"  
						...
						styleClass="boxCombo"  readonly="false"></html:textarea>			
				</td>
			</tr>
		</table>
	</html:form>
