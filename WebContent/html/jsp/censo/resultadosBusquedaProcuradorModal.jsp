...
<body class="tablaCentralCampos">
		...
		<siga:TablaCabecerasFijas 
		   ...
		   borde="1"
		   clase="tableTitle"
		   nombreCol="censo.busquedaClientesAvanzada.literal.nColegiado,censo.busquedaClientes.literal.codigo,gratuita.turnos.literal.apellidosSolo,censo.busquedaClientesAvanzada.literal.nombre,"
		   tamanoCol="20,20,35,20,5"
		   alto="100%"
