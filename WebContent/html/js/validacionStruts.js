  ...
  function isAllDigits(argvalue) {
      ...
      var startFrom = 0;
/*      if (argvalue.substring(0, 2) == "0x") {				// Validacion hexadecimal
         validChars = "0123456789abcdefABCDEF";
         startFrom = 2;
*/
/*      } else if (argvalue.charAt(0) == "0") {				// Validacion octal
         validChars = "01234567";
         startFrom = 1;
     } else 
*/
  ...
  function checkEmail(emailStr) {
     ...
     //La longitud del dominio debe estar comprendido entre 2 y 20 caracteres(antes no podia superar los 3)
 ...
 <!-- RGG  Para Bug del parseint con ceros a la izquierda -->
