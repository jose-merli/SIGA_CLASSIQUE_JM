...
/*
	Al usar Javascript y referencias directas entre páginas HTML,
	el prototipo necesita que los formularios sean de tipo GET,
	para poder realizar el paso de parámetros entre distintos formularios
	abiertos en el mismo target.
	Este método implementa la funcionalidad de obtener un array de dos dimensiones
	(pares nombre/valor) conteniendo los parámetros que se pasan en una peticion get.
*/
function getFormParameters() {
	var allArgs=new Array();
	var counter=0;
	//el primer caracter es '?', y lo sustituímos por '&' para la busqueda de parametros
...
/* TNF 
	Función para dejar una imagen asociada a un link activada tras pulsar sobre éste.
	El link no debe tener atributo class, y cualquier link en la misma página que no lleve
	imagenes, debe tener algún valor para ese atributo
*/
