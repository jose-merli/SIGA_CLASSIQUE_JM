CREATE OR REPLACE PROCEDURE uscgae.PROC_RESPUESTAEJG_2003(P_IDINSTITUCION      IN CAJG_REMESARESOLUCION.IDINSTITUCION%type,
      ...
      --mETEMOS EL ESTADO DEVUELTO AL COLEGIO
          ...
          VALUES
            (P_IDINSTITUCION,
             ...
             NULL);
        END IF;
        --CAMBIAMOS EL CAMPO RECIBIDA DEL EJG INCLUIDO EN LA REMESA A 1 Recibida respuesta 
