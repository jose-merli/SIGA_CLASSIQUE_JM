...
--              THEN (SELECT J.CODIGOEXT FROM SCS_JUZGADO J WHERE J.IDINSTITUCION = ASIS.JUZGADOIDINSTITUCION AND J.IDJUZGADO = ASIS.JUZGADO)
      ...
      ,(SELECT CODIGOEXT FROM CEN_INSTITUCION P WHERE P.IDINSTITUCION = COL_D.IDINSTITUCION) AS A_COLEXIO
      ...
      WHERE P.IDCOLPROCURADOR = CP.IDCOLPROCURADOR AND P.IDPROCURADOR = PROCD.IDPROCURADOR AND P.IDINSTITUCION = PROCD.IDINSTITUCION) AS  PR_COLEXIO
