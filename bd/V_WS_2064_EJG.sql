CREATE OR REPLACE VIEW USCGAE.V_WS_2064_EJG AS
...
--              THEN (SELECT J.CODIGOEXT FROM SCS_JUZGADO J WHERE J.IDINSTITUCION = ASIS.JUZGADOIDINSTITUCION AND J.IDJUZGADO = ASIS.JUZGADO)
      ...
      , (SELECT SUBSTR(P.CODIGO, INSTR(P.CODIGO, '-')+1) FROM PCAJG_ICAS P, PCAJG_ICAS_CENINSTITUCION PS
                WHERE P.IDENTIFICADOR = PS.IDENTIFICADOR
                AND P.IDINSTITUCION = PS.IDINSTITUCION_PCAJG
                AND P.IDINSTITUCION = DECODE(COL_AS.IDPERSONA, NULL, COL_D.IDINSTITUCION, COL_AS.IDINSTITUCION)
                AND PS.IDINSTITUCION_SIGA = DECODE(COL_AS.IDPERSONA, NULL, COL_D.IDINSTITUCION, COL_AS.IDINSTITUCION)) AS A_COLEXIO
      ...
      , (SELECT SUBSTR(P.CODIGO, INSTR(P.CODIGO, '-')+1) FROM PCAJG_ICAPROCURADOR P, PCAJG_ICAPROC_CENINSTI PS
                WHERE P.IDENTIFICADOR = PS.IDENTIFICADOR
                AND P.IDINSTITUCION = PS.IDINSTITUCION_PCAJG
                AND PS.IDINSTITUCION_SIGA = DECODE(PROCD.IDPROCURADOR, NULL, PROCEJG.IDINSTITUCION, PROCD.IDINSTITUCION)
