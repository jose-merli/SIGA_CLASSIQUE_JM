...
CREATE TABLE "USCGAE_INT"."CAJG_GRUPOEXPEDIENTESS" 
   (	"IDINSTITUCION" NUMBER(4,0) NOT NULL ENABLE, 
	"IDGRUPOEXPEDIENTES" NUMBER(2,0) NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(100) NOT NULL ENABLE,
	"CODEXTERNO" VARCHAR2(5)  NOT NULL ENABLE,
	"FECHAMODIFICACION" DATE NOT NULL ENABLE, 
	"USUMODIFICACION" NUMBER(5,0) NOT NULL ENABLE
   );
  CREATE UNIQUE INDEX "USCGAE_INT"."CAJG_GRUPOEXPEDIENTESS" ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTESS" ("IDINSTITUCION", "IDGRUPOEXPEDIENTES") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 2097152 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TS_SIGA_CMN_IDX" ;
ALTER TABLE "USCGAE_INT"."CAJG_GRUPOEXPEDIENTESS" ADD CONSTRAINT "PK_CAJG_GRUPOEXPEDIENTESS" PRIMARY KEY ("IDINSTITUCION", "IDGRUPOEXPEDIENTES")
  USING INDEX "USCGAE_INT"."PK_CAJG_GRUPOEXPEDIENTESS"  ENABLE;
ALTER TABLE USCGAE_INT.CAJG_REMESA ADD CONSTRAINT CAJG_REMESA_CAJG_GRUPOEXPEDIENTES_FK FOREIGN KEY (IDINSTITUCION,IDGRUPOEXPEDIENTES) REFERENCES USCGAE_INT.CAJG_GRUPOEXPEDIENTES(IDINSTITUCION,IDGRUPOEXPEDIENTES);

  

GRANT SELECT ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_R";
  GRANT SELECT ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_SIGA_R";
  GRANT DELETE ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_RW";
  GRANT INSERT ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_RW";
  GRANT SELECT ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_RW";
  GRANT UPDATE ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_RW";
  GRANT ALTER ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT DELETE ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT INSERT ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT SELECT ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT UPDATE ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT READ ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT ON COMMIT REFRESH ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT QUERY REWRITE ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT DEBUG ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  GRANT FLASHBACK ON "USCGAE_INT"."CAJG_GRUPOEXPEDIENTES" TO "ROLE_USCGAE_INT_DDL";
  
  


INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	1	,001	,'INSUFICIENCIA RECURSOS GENERAL',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	2	,002	,'INSUFICIENCIA RECURSOS EXTRANJERIA',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	3	,003	,'SOCIAL 2d',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	4	,004	,'VICTIMAS 2h',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	5	,005	,'NEGATIVOS',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	6	,006	,'PENAL',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	7	,007	,'PENAL JUICIOS RAPIDOS',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	8	,008	,'MENORES',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	9	,009	,'ARCHIVADOS',sysdate,0);
INSERT	INTO	USCGAE_INT.CAJG_GRUPOEXPEDIENTES (IDINSTITUCION,	IDGRUPO,	CODEXTERNO,	NOMBRE,	FECHAMODIFICACION,	USUMODIFICACION) VALUES(2003,	10	,010	,'EXTRAORDINARIOS',sysdate,0);

ALTER TABLE USCGAE_INT.CAJG_REMESA ADD IDGRUPOEXPEDIENTES NUMBER(2,0) NULL;

COGER f_comunicaciones_ejg_2003_CAB DE INT

ALTER TABLE USCGAE_INT.PCAJG_ALC_INT_EXP ADD EXP17_GRUPO_DOC VARCHAR2(3) NULL;
