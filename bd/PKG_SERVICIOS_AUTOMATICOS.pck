        ...
        WHERE SUSCRIPCION.IDINSTITUCION = p_Idinstitucion
            ...
            AND EXISTS (
                ...
                FROM PYS_SERVICIOSSOLICITADOS SERVICIOSSOLICITADOS,
                    PYS_FORMAPAGOSERVICIOS FORMAPAGO,
                ...
                WHERE SERVICIOSSOLICITADOS.IDINSTITUCION = SUSCRIPCION.IDINSTITUCION
                    ...
                    AND SERVICIOSSOLICITADOS.IDINSTITUCION = FORMAPAGO.IDINSTITUCION
                    AND SERVICIOSSOLICITADOS.IDTIPOSERVICIOS = FORMAPAGO.IDTIPOSERVICIOS
                    AND SERVICIOSSOLICITADOS.IDSERVICIO = FORMAPAGO.IDSERVICIO
                    AND SERVICIOSSOLICITADOS.IDSERVICIOSINSTITUCION = FORMAPAGO.IDSERVICIOSINSTITUCION
                    AND FORMAPAGO.IDFORMAPAGO = 20 -- Admite domiciliacion bancaria
