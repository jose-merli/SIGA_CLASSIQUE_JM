CREATE OR REPLACE VIEW USCGAE.V_PCAJG_EJG AS
SELECT EJGREMESA.IDREMESA
      ...
      , (CASE
       ...
       , '3.1.2' AS VERSION_XSD_GENERALITAT
      ...
      , Decode(I.Cen_Inst_IdInstitucion, 3001, Decode(Vdp.Sexo, 'M', 'M', 'F', 'F', 'N'), VDP.SEXO) AS DS_DP_SEXO
    ...
    , VDP_REP.MUNICIPIO_EJIS AS DR_DP_DD_M_MUNICIPIO_EJIS
      ...
      , (CASE
             WHEN D.IDJUZGADO IS NOT NULL
             THEN (SELECT (CASE
              WHEN I.CEN_INST_IDINSTITUCION IN (3001, 3010,3004)
              THEN J.CODIGOEXT
