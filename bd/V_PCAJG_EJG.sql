...
SELECT EJGREMESA.IDREMESA
    ...
    , VDP.MUNICIPIO_EJIS AS DS_DP_DD_M_MUNICIPIO_EJIS
      ...
      , VDP.AUTORIZAAVISOTELEMATICO AS DS_DC_AVISOTELEMATICO
    ...
    , VDP_REP.MUNICIPIO_EJIS AS DR_DP_DD_M_MUNICIPIO_EJIS
      ...
      , VDP_REP.AUTORIZAAVISOTELEMATICO AS DR_DC_AVISOTELEMATICO
      ...
      , (CASE
              WHEN
                D.IDJUZGADO IS NOT NULL AND  I.CEN_INST_IDINSTITUCION IN (3001, 3010,3009)
              THEN
              ...
              WHEN
                D.IDJUZGADO IS NOT NULL AND  I.CEN_INST_IDINSTITUCION NOT IN (3001, 3010,3009)
              THEN
               (SELECT PJ.CODIGOEXT || '##' || PJ.NOMBRE
                ...
                AND POB.IDPARTIDO = PJ.IDPARTIDO)
              WHEN
                EJG.JUZGADO IS NOT NULL AND  I.CEN_INST_IDINSTITUCION IN (3001, 3010,3009)
              THEN
                (SELECT LPAD(PJ.IDPARTIDO, 4, '0') || '##' || PJ.NOMBRE
                FROM CEN_PARTIDOJUDICIAL PJ, CEN_POBLACIONES POB, SCS_JUZGADO J
                ...
                AND POB.IDPARTIDO = PJ.IDPARTIDO)
               WHEN
                EJG.JUZGADO IS NOT NULL AND  I.CEN_INST_IDINSTITUCION NOT IN (3001, 3010,3009)
              THEN
                (SELECT  PJ.CODIGOEXT || '##' || PJ.NOMBRE
                FROM CEN_PARTIDOJUDICIAL PJ, CEN_POBLACIONES POB, SCS_JUZGADO J
                WHERE J.IDINSTITUCION = EJG.JUZGADOIDINSTITUCION
